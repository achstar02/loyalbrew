...
const LANGS = {
  en: {
    ...
    'Points settings saved! / 积分设置已保存': 'Points settings saved!',
    'Shop info saved! / 店铺信息已保存': 'Shop info saved!',
    loyalbrew_lang: 'en',
    loyalbrew_merchant_lang: 'en',
    loyalbrew_merchant_phone: '',
    loyalbrew_topup_bonus_rules: '',
    '加分成功': 'Points added successfully!',
  ...
  zh: {
    ...
    // Landing
    tagline: '点餐 • 赚积分 • 换奖励',
    loginLabel: 'Member Login', myAccount: '我的账号', orderNow: '立即点餐', myStampCard: '印章卡',
    ...
    // Float cart
    floatViewCart: '查看购物车 →',
    floatItem: '件', floatItems: '件',
    // Takeaway info bar
    takeawayOrder: '外卖订单', noPickupTime: '未设置取餐时间', pickup: '取餐',
    // Cart
    yourOrder: '我的订单', orderType: '订单类型',
    phoneNumber: '手机号码', pickupTime: '取餐时间',
    pickupHint: '我们将在此时间前备好您的餐。',
    loyaltyPoints: '积分 & 印章',
    earnHint: '输入手机号并点击 🔍 以赚取积分和印章',
    phoneLoyalty: '手机号码（赚积分 & 印章）',
    payWallet: '钱包付款', useWallet: '使用钱包余额付款', walletBalance: '余额',
    paymentMethod: '付款方式',
    cartEmpty: '购物车是空的', browseMenu: '浏览菜单',
    eachUnit: '每件', removeItem: '删除',
    orderSummary: '订单摘要', subtotal: '小计', sst: '消费税 (6%)',
    walletDeduction: '钱包扣款', totalLabel: '总计',
    pointsEarnLabel: '您将获得的积分',
    specialRequest: '特殊要求', specialRequestPlaceholder: '例：少糖、不要冰...',
    placeOrder: '下单',
    // Order type display in cart
    cartDineIn: '堂食', cartTakeaway: '外卖', cartChange: '更改',
    // Confirm details
    confirmType: '类型', confirmTable2: '桌号', confirmPhone: '电话',
    confirmPickup: '取餐时间', confirmItems: '餐点',
    confirmWalletPaid: '钱包支付', confirmTotalPaid: '总付金额',
    confirmPayment: '付款方式', confirmPointsEarned: '获得积分',
    confirmNote: '备注', pendingVerification: '待验证',
    confirmTypeDineIn: '🪑 堂食', confirmTypeTakeaway: '🛍️ 外卖',
    // Cash pay confirm
    cashPayCounter: '请到柜台付款，然后点击下方按钮。',
    cashPaidBtn: '我已付款 — 通知厨房',
    cashPaidDone: '付款已确认！厨房正在准备您的餐点。',
    confirmReceivedBtn: '确认收到 / 完成订单',
    orderCompletedMsg: '🎉 订单已完成！感谢您的订购。',
    orderCompletedTitle: '订单已完成',
    // Toast
    toastTakeaway: '🛍️ 外卖订单已下单！', toastDineIn: '🍳 订单已发送至厨房！',
    toastNoPhone: '请输入外卖手机号码',
    toastNoTime: '请设置取餐时间',
    toastNoProof: '请先上传付款截图。',
    // Payment section
    tngScanTitle: '扫码 Touch & Go 付款',
    tngAmountLabel: '金额', tngUploadHint: '付款后，请在下方上传截图。',
    uploadScreenshot: '上传付款截图', uploadReceipt: '上传转账收据',
    uploadSizeHint: 'JPG / PNG，最大 5MB',
    bankTitle: '银行转账详情',
    // Takeaway modal
    takeawayModalTitle: '外卖订单', takeawayModalSubtitle: '请输入取餐信息',
    confirmTakeaway: '确认外卖', cancelBtn: '取消',
    pickupReadyHint: '我们将在此时间前备好您的餐。',
    // Stamp
    enterPhone: '输入您的手机号',
    notMember: '还不是会员？', registerHere: '点击注册',
    // Order Confirm
    orderPlaced: '订单成功！', thankYou: '谢谢！',
    orderSent: '您的订单已发送到厨房。',
    orderMore: '继续点餐', viewStamp: '查看印章卡', backHome: '返回首页',
    // Stamp card
    stampReward: '奖励', stampClaimBtn: '领取奖励',
    stampPerPurchase: '每次购买获1个印章',
    stampPerAmount: '每消费RM{v}获1个印章',
    stampPerItem: '每购买{item}获1个印章',
    stampPerItemGeneric: '每购买指定商品获1个印章',
    stampFreeItem: '免费{item}', stampFreeItemGeneric: '免费商品',
    stampRmOff: '减免RM{v}', stampPctOff: '{v}折优惠', stampBonusPoints: '+{v}积分',
    stampsToUnlock: '还差{n}个印章解锁奖励', stampsToUnlockPlural: '还差{n}个印章解锁奖励',
    stampCollected: '已集', stampEmpty: '未集',
    stampCompleted: '已完成{n}次',
    // Customer Auth
    login: 'Sign In', register: '注册', fullName: '全名',
    memberDeactivatedMsg: '您的账号已被商家解除。请联系商家处理。',
    // Dashboard
    memberLabel: '会员', totalPoints: '总积分', memberId: '会员号',
    tierProgress: '等级进度',
    tierBronze: '铜牌\n0', tierSilver: '银牌\n200', tierGold: '金牌\n500', tierPlatinum: '铂金\n1000',
    redeemRewards: '兑换奖励', viewAllStampCards: '查看全部印章卡',
    myOrders: '我的订单', viewAllOrders: '查看全部订单',
    referralCommissions: '推荐佣金', myReferralProgram: '我的推荐计划',
    transactionHistory: '交易记录', logout: '退出登录', submitComplaint: '提交投诉',
    // My Orders page
    loginRequired: '需要会员登录', loginToViewOrders: '请先登录以查看订单记录。',
    goToLogin: '前往会员登录',
    filterAll: '全部', filterPending: '待处理', filterPreparing: '准备中', filterDone: '完成',
    // Top Up page
    topUpWallet: '钱包充值', myWallet: '我的钱包', bonusIncluded: '赠额已包含',
    topUpBonusTitle: '充值优惠！', topUpBonusDesc: '充值RM100获得RM120（免费赠送RM20！）',
    selectTopUpAmount: '选择充值金额', topUpGet: '获得', noBonus: '无赠额',
    bestDeal: '最优惠', free: '免费',
    orCustomAmount: '或输入自定义金额 (RM)',
    topUpCustomHint: '最低RM10。充值RM100及以上享受赠额。',
    youPay: '您支付', youGet: '您获得', bonusLabel: '赠额',
    confirmTopUp: '确认充值', walletHistory: '钱包记录',
    // Wallet dashboard
    availableBalance: '可用余额', totalToppedUp: '累计充值', totalBonusEarned: '累计赠额',
    // Tier hint
    sinceLabel: '加入于',
    pointsToReach: '还需{n}积分升至{tier}！',
    highestTier: '🏆 已达最高等级！',
    tierNameSilver: '银牌', tierNameGold: '金牌', tierNamePlatinum: '铂金',
    // Upload
    screenshotUploaded: '截图已上传，等待商家审核。',
    screenshotUploaded2: '截图已上传', tapToChange: '点击更换',
    topupSubmitted: '✅ 充值申请已提交！等待商家审核。',
    selectTableFirst: '请先选择桌号！',
    photoUnder5MB: '图片大小不能超过5MB',
    noPromos: '暂无优惠',
    noComplaintsYet: '暂无投诉记录',
    ...
    mEnterValidBill: '输入有效账单',
    mFreeCoffee: '免费咖啡',
    mMemberInactive: '会员已停用',
    mNoMembersYet: '暂无会员',
    mOrderPickup: '订单取餐',
    mOrderPrepare: '准备中',
    mOrderTakeaway: '外卖订单',
    ...
    credited_to_referrer_s_wallet_after_first_order: '首单后自动入账推荐人钱包',
    customer_complaints: '顾客投诉',
    enter_your_referrer_s_phone_number_to_link_commissions: '输入推荐人手机号以关联佣金',
    ...
    no_pending_payment_proofs: '暂无待处理支付凭证',
    no_pending_requests: '暂无待处理请求',
    number_of_tables: '桌数',
    pending_payment_proofs: '待处理支付凭证',
    pending_top_up_requests: '待处理充值请求',
    refresh: '刷新',
    resolved: '已解决',
    search_for_a_member: '搜索会员',
    takeaway: '外卖',
    tierGold: '黄金',
    tierPlatinum: '铂金',
    tierSilver: '白银',
    ...
    enterPhoneSearch: '请输入手机号码',
    memberNotFoundExcl: '会员不存在！',
    enterValidBill: '请输入有效账单金额',
    fillNamePrice: '请填写名称和价格',
    qrNotReady: '二维码尚未生成',
    complaintSubmitted: '✅ 投诉已提交！我们会尽快回复您。',
    // Complaint form
    ...
    photo_upload_hint: 'JPG、PNG，最大5MB',
    order_id_optional: '订单ID（可选）',
    myComplaints: '我的投诉',
    // Dynamic render strings
    stampCollectedMsg: '印章已集！',
    stampCollectedDetail: '查看印章卡领取奖励',
    walletTopupPending: '等待商家审核',
    myOrdersEmpty: '没有找到订单',
    myOrdersNoOrdersYet: '暂无订单',
    walletTxnsEmpty: '暂无钱包交易记录',
    txnNoTransactions: '暂无交易记录',
    topupHistoryEmpty: '暂无充值记录',
    complaintsEmpty: '没有找到投诉',
    photoUploadHint: 'JPG、PNG，最大 5MB',
    orderDetailTitle: '订单详情',
    orderDetailOrderId: '订单号',
    orderDetailStatus: '状态',
    orderDetailType: '类型',
    orderDetailDate: '日期',
    orderDetailItems: '已点餐点',
    ...
    awaitingMerchantApproval: '等待商家审核',
    newItemsNewTag: '新品',
    stampComplete: '已完成！',
    complaintTab: '投诉',
    referralTab: '推荐',
    ...
    orderDetailWalletDeductLabel: '钱包扣款',
    active_new_launches: '进行中的新发布',
    active_stamp_cards: '有效的印章卡',
    ...
    referral_code_label: '推荐码（推荐人手机号，可选）',
    ...
    username: '用户名',
    wrong_order: '错单',
    referralCommissionEarned: '已赚佣金',
    referralCurrentRate: '当前费率',
    referralSharePrompt: '分享您的手机号 {phone} 作为推荐码，赚取好友首单 {rate}% 佣金！',
    // Ads
    ads: '广告',
    create_ad: '创建新广告',
    ad_title: '广告标题',
    ...
    promosAndDeals: '优惠促销',
    viewAllPromos: '查看所有优惠',
    allPromos: '所有优惠',
    noPromosNow: '暂无优惠活动，请稍后再来！',
 
    welcomeBack: '欢迎回来',
    drinkToday: '今天想喝点什么？',
    firebaseNote: '主按钮会在后续接 Firebase：检查商家 credits，成功操作后自动扣 1。',
    enter: '进入',
    get: '获取',
    view: '查看',
    back: '返回',
    superAdmin: '超级管理',
    quickActions: '快捷操作 / Quick Actions',
    viewOrders2: '查看订单',
    menuMgmt2: '菜单管理',
    shopSettings2: '店铺设置',
    kitchenDisplay2: '厨房显示',
    confirmPoints: '确认加分',
    topUpGateway: '充值（对接支付网关）',
    shopInfo: '店铺信息',
    shopName: '店名',
    announcement: '公告',
    bannerUrl: '横幅图片',
    ...
    savePoints2: '保存', 
    // ===== MISSING KEYS (Merchant Dashboard + Others) =====
    mLoginBtn: '登录', mVerify: '验证', mRefreshed: '已刷新',
    mInvalidCredentials: '用户名或密码错误',
    mMemberActive: '已激活', mMemberInactive: '已停用',
    mActivateMember: '激活会员', mDeactivateMember: '停用会员',
    mActivateBtn: '激活', mDeactivateBtn: '停用',
    mConfirmActivate: '确认激活此会员？',
    mConfirmDeactivate: '确认停用此会员？',
    mOrderDone: '已完成', mOrderPrepare: '准备中',
    mOrderCompleted: '已完成', mOrderPickup: '待取餐',
    mOrderTable: '桌号', mOrderTakeaway: '外卖',
    mOrderMovedPreparing: '已移至准备中',
    mFirstOrderDone: '首单完成！', mNotOrderedYet: '尚未下单',
    mNoOrdersFound: '未找到订单。', mNoOrdersCategory: '该分类无订单。',
    mKitchenStartCooking: '开始制作', mKitchenCookingStarted: '已开始制作',
    mKitchenMarkDone: '标记完成', mKitchenCompleted: '已完成',
    mKitchenGuest: '顾客', mKitchenTable: '桌号', mKitchenTakeaway: '外卖', mKitchenPickup: '取餐',
    mEnterPhone: '输入手机号', mEnterCardName: '输入卡名称',
    mFillNamePrice: '填写名称和价格',
    mNoMembersFound: '未找到会员。', mNoMembersYet: '暂无会员。',
    mStampActivate: '激活', mStampActive: '有效',
    mStampPause: '暂停', mStampPaused: '已暂停',
    mStampDelete: '删除', mStampMembers: '会员',
    mStampPerItem: '按件', mStampPerPurchase: '按单', mStampPerRM: '按金额',
    mStampsLabel: '印章数', mNoStampCardsYet: '暂无印章卡。',
    mNiLaunch: '发布', mNiWas: '原价', mNiSpecial: '特价：',
    mNiEnds: '截止：', mNiNoEndDate: '无截止日期',
    mNiDeactivate: '下架', mNiDelete: '删除',
    mNoActiveItems: '没有进行中的新品。', mNoPastLaunches: '没有历史发布。',
    mTopupSubmitted: '充值申请已提交！', mTopupApproved: '已通过', mTopupRejected: '已拒绝',
    mNoPendingRequests: '待处理请求。', mNoTopupHistory: '暂无充值记录。',
    mMinTopupAmount: '最低充值RM10',
    mBalance: '余额', mPoints: '积分',
    mNoTransactions: '暂无交易记录。',
    mAddRule: '添加规则', mDeleteRule: '删除规则',
    mBonusPercent: '赠额比例', mBonusPct: '%', mBonusPtsLabel: '赠额积分',
    mBonusExpiry: '到期日', mNoExpiry: '永不过期',
    mMinAmt: '最低金额(RM)', mEnterValidBill: '请输入有效金额',
    mEnterValidRate: '请输入有效比例(1-100)',
    mRewardFreeItem: '免费商品', mRewardFlatDiscount: '固定减免(RM)',
    mRewardPctDiscount: '百分比折扣(%)', mRewardBonusPoints: '赠额积分',
    mPurchase: '消费', mRmOff: '减免RM', mPctOff: '折',
    mFreePrefix: '免费', mFreeItem: '免费商品', mFreeCoffee: '免费咖啡',
    mComplaintOpen: '待处理', mComplaintInProgress: '处理中',
    mComplaintResolved: '已解决', mComplaintNoPhoto: '无附件',
    mApprove: '通过', mReject: '拒绝',
    mNoComplaintsFound: '未找到投诉。',
    mNoCommissions: '暂无佣金记录。',
    mPaymentVerified: '已验证', mPaymentRejected: '已拒绝',
    mNoPaymentProofs: '暂无付款凭证。',
    mPhotoUnder5MB: '图片不能超过5MB',
    mQRNotReady: '二维码未生成', mQRPrint: '打印二维码', mQRTable: '桌号二维码',
    mSelectMenuItem: '选择菜单项', mChooseAnItem: '选择商品',
    mExpired: '已过期',
    mDetailStatus: '状态', mDetailDate: '日期', mDetailCustomer: '顾客',
    mDetailOrder: '订单', mDetailCategory: '分类',
    mDetailPrevResponse: '上次回复',
    points: '积分', noStampCards: '暂无印章卡',
    'Item removed': '商品已移除',
    'Points settings saved! / 积分设置已保存': '积分设置已保存！',
  ...
  ms: {
    ...
    confirmTypeDineIn: '🪑 Makan Di Sini', confirmTypeTakeaway: '🛍️ Bawa Balik',
    // Cash pay confirm
    ...
    // Toast
    toastTakeaway: '🛍️ Pesanan bawa balik dibuat!', toastDineIn: '🍳 Pesanan dihantar ke dapur!',
    ...
    'Points settings saved! / 积分设置已保存': 'Tetapan mata disimpan!',
...
loyalbrew_brand: 'LoyalBrew',
    ...
    demo_label: 'டெமோ:',
    email_optional: 'மின்னஞ்சல் (கட்டாயமற்றது)',
    referral_code_label: 'பரிந்துரை குறியீடு (பரிந்துரைக்கும் தொலைபேசி, கட்டாயமற்றது)',
    admin_label: 'admin',
    menu: 'மெனு',
    new_items: 'புதிய பொருட்கள்',
    bill_amount: 'பில் தொகை (RM)',
    all: 'அனைத்தும்',
    pending: 'காத்திருக்கும்',
    preparing: 'தயாராகிக்கொண்டிருக்கும்',
    done: 'முடிந்தது',
    price_label: 'விலை (RM)',
    ...
    desserts: 'இனிப்புகள்',
    snacks: 'சிற்றுண்டி',
    card_emoji_icon: 'கார்டு இமோஜி/ஐகான்',
    flat_discount: 'நிலையான தள்ளுபடி (RM)',
    min_amount: 'குறைந்தபட்ச தொகை (RM)',
    qr_description: 'ஒவ்வொரு மேசைக்கும் தனித்துவமான QR குறியீடு உள்ளது. வாடிக்கையாளர்கள் ஸ்கேன் செய்து நேரடியாக ஆர்டர் செய்யலாம்.',
    congratulations: 'வாழ்த்துக்கள்!',
    stamps_collected: 'நீங்கள் அனைத்து ஸ்டாம்ப்களையும் சேகரித்துவிட்டீர்கள்!',
    whats_new_title: 'LoyalBrew இல் புதியது!',
    invite_friends_title: 'நண்பர்களை அழைத்து கமிஷன் சம்பாதியுங்கள்!',
    no_commissions_yet: 'இன்னும் கமிஷன் இல்லை. பரிந்துரைத்து தொடங்குங்கள்!',
    upload_photo_optional: 'புகைப்படத்தை பதிவேற்று (கட்டாயமற்றது)',
    order_id_optional: 'ஆர்டர் ஐடி (கட்டாயமற்றது)',
    response_action_taken: 'பதில் / மேற்கொள்ளப்பட்ட நடவடிக்கை',
    // Landing
    tagline: 'ஆர்டர் • புள்ளிகள் சம்பாதி • பரிசு பெறு',
    loginLabel: 'உறுப்பினர் உள்நுழைவு', myAccount: 'என் கணக்கு', orderNow: 'இப்போது ஆர்டர்', myStampCard: 'ஸ்டாம்ப் கார்டு',
    topUp: 'டாப் அப்', merchant: 'வணிகர்',
    feat1Title: 'ஸ்கேன் & ஆர்டர்', feat1Desc: 'QR ஸ்கேன் செய்து உடனே ஆர்டர்',
    feat2Title: 'புள்ளிகள் சம்பாதி', feat2Desc: 'RM1 = 1 புள்ளி',
    feat3Title: 'இலவச பானங்கள்', feat3Desc: 'புள்ளிகளை பரிசாக மாற்றவும்',
    // Menu
    menu: 'மெனு', dineIn: 'உள்ளே சாப்பிட', takeaway: 'வெளியே எடுக்க',
    table: 'மேசை', change: 'மாற்று',
    selectTable: 'உங்கள் மேசையை தேர்ந்தெடுக்கவும்', enterTable: 'ஆர்டர் செய்ய மேசை எண் உள்ளிடவும்',
    confirmTable: 'மேசையை உறுதிப்படுத்து', invalidTable: 'சரியான மேசை எண்ணை உள்ளிடவும்',
    // Menu categories
    catAll: 'அனைத்தும்', catNewItems: '✨ புதிய பொருட்கள்',
    catHotDrinks: 'சூடான பானங்கள்', catColdDrinks: 'குளிர் பானங்கள்',
    catFood: 'உணவு', catDesserts: 'இனிப்புகள்', catSnacks: 'சிற்றுண்டி',
    // Float cart
    floatViewCart: 'கார்ட் பார்க்க →',
    floatItem: 'பொருள்', floatItems: 'பொருட்கள்',
    // Takeaway info bar
    takeawayOrder: 'டேக்அவே ஆர்டர்', noPickupTime: 'நேரம் அமைக்கப்படவில்லை', pickup: 'எடுக்கும்',
    // Cart
    yourOrder: 'என் ஆர்டர்', orderType: 'ஆர்டர் வகை',
    phoneNumber: 'தொலைபேசி எண்', pickupTime: 'எடுக்கும் நேரம்',
    pickupHint: 'இந்த நேரத்தில் உங்கள் ஆர்டர் தயாராக இருக்கும்.',
    loyaltyPoints: 'புள்ளிகள் & ஸ்டாம்ப்',
    earnHint: 'புள்ளிகள் & ஸ்டாம்ப் பெற தொலைபேசி எண் உள்ளிட்டு 🔍 அழுத்தவும்',
    phoneLoyalty: 'தொலைபேசி எண் (புள்ளிகள் & ஸ்டாம்ப் பெற)',
    payWallet: 'வாலட்டில் பணம் செலுத்து', useWallet: 'வாலட் இருப்பைப் பயன்படுத்து',
    paymentMethod: 'பணம் செலுத்தும் முறை',
    cartEmpty: 'கார்ட் காலியாக உள்ளது', browseMenu: 'மெனு பார்க்க',
    eachUnit: 'ஒவ்வொன்றும்', removeItem: 'நீக்கு',
    orderSummary: 'ஆர்டர் சுருக்கம்', subtotal: 'துணை மொத்தம்', sst: 'SST (6%)',
    walletDeduction: 'வாலட் கழிவு', totalLabel: 'மொத்தம்',
    pointsEarnLabel: 'நீங்கள் பெறும் புள்ளிகள்',
    specialRequest: 'சிறப்பு கோரிக்கை', specialRequestPlaceholder: 'எ.கா: குறைந்த சர்க்கரை, ஐஸ் வேண்டாம்...',
    placeOrder: 'ஆர்டர் செய்',
    // Order type display in cart
    cartDineIn: 'உள்ளே சாப்பிட', cartTakeaway: 'வெளியே எடுக்க', cartChange: 'மாற்று',
    // Confirm details
    confirmType: 'வகை', confirmTable2: 'மேசை', confirmPhone: 'தொலைபேசி',
    confirmPickup: 'எடுக்கும் நேரம்', confirmItems: 'பொருட்கள்',
    confirmWalletPaid: 'வாலட் பணம்', confirmTotalPaid: 'மொத்த தொகை',
    confirmPayment: 'பணம் செலுத்தல்', confirmPointsEarned: 'புள்ளிகள் பெறப்பட்டது',
    confirmNote: 'குறிப்பு', pendingVerification: 'சரிபார்ப்பு நிலுவையில்',
    confirmTypeDineIn: '🪑 உள்ளே சாப்பிட', confirmTypeTakeaway: '🛍️ வெளியே எடுக்க',
    // Cash pay confirm
    cashPayCounter: 'கவுண்டரில் பணம் செலுத்தவும், பிறகு கீழே உள்ள பொத்தானை அழுத்தவும்.',
    cashPaidBtn: 'நான் செலுத்தினேன் — சமையலறையை தெரிவிக்கவும்',
    cashPaidDone: 'பணம் உறுதிப்படுத்தப்பட்டது! சமையலறை உங்கள் ஆர்டரை தயாரிக்கிறது.',
    ...
    // Toast
    toastTakeaway: '🛍️ டேக்அவே ஆர்டர் வெற்றி!', toastDineIn: '🍳 ஆர்டர் சமையலறைக்கு அனுப்பப்பட்டது!',
    toastNoPhone: 'டேக்அவேக்கு தொலைபேசி எண் உள்ளிடவும்',
    toastNoTime: 'எடுக்கும் நேரத்தை அமைக்கவும்',
    toastNoProof: 'முதலில் பணம் செலுத்திய ஸ்கிரீன்ஷாட்டை பதிவேற்றவும்.',
    // Payment section
    tngScanTitle: 'Touch & Go மூலம் பணம் செலுத்த ஸ்கேன் செய்யவும்',
    tngAmountLabel: 'தொகை', tngUploadHint: 'பணம் செலுத்திய பிறகு, கீழே ஸ்கிரீன்ஷாட் பதிவேற்றவும்.',
    uploadScreenshot: 'பணம் செலுத்திய ஸ்கிரீன்ஷாட் பதிவேற்று', uploadReceipt: 'பரிமாற்ற ரசீது பதிவேற்று',
    uploadSizeHint: 'JPG / PNG 5MB வரை',
    bankTitle: 'வங்கி பரிமாற்ற விவரங்கள்',
    // Stamp
    enterPhone: 'உங்கள் தொலைபேசி எண்ணை உள்ளிடவும்',
    notMember: 'உறுப்பினர் இல்லையா?', registerHere: 'இங்கே பதிவு செய்யுங்கள்',
    // Order Confirm
    orderPlaced: 'ஆர்டர் வெற்றி!', thankYou: 'நன்றி!',
    orderSent: 'உங்கள் ஆர்டர் சமையலறைக்கு அனுப்பப்பட்டது.',
    orderMore: 'மேலும் ஆர்டர்', viewStamp: 'ஸ்டாம்ப் கார்டு பார்க்க', backHome: 'முகப்புக்கு திரும்பு',
    // Takeaway modal
    takeawayModalTitle: 'டேக்அவே ஆர்டர்', takeawayModalSubtitle: 'உங்கள் பிக்அப் விவரங்களை உள்ளிடவும்',
    confirmTakeaway: 'டேக்அவே உறுதிப்படுத்து', cancelBtn: 'ரத்து செய்',
    pickupReadyHint: 'இந்த நேரத்தில் உங்கள் ஆர்டர் தயாராக இருக்கும்.',
    // Stamp card
    stampReward: 'பரிசு', stampClaimBtn: 'பரிசு பெறு',
    stampPerPurchase: 'ஒவ்வொரு கொள்முதலுக்கும் 1 ஸ்டாம்ப்',
    stampPerAmount: 'RM{v} செலவிட்டால் 1 ஸ்டாம்ப்',
    stampPerItem: 'ஒவ்வொரு {item} வாங்கினாலும் 1 ஸ்டாம்ப்',
    stampPerItemGeneric: 'தகுதியான பொருள் வாங்கினாலும் 1 ஸ்டாம்ப்',
    stampFreeItem: 'இலவச {item}', stampFreeItemGeneric: 'இலவச பொருள்',
    stampRmOff: 'RM{v} தள்ளுபடி', stampPctOff: '{v}% தள்ளுபடி', stampBonusPoints: '+{v} போனஸ் புள்ளிகள்',
    stampsToUnlock: 'பரிசு பெற {n} ஸ்டாம்ப் தேவை', stampsToUnlockPlural: 'பரிசு பெற {n} ஸ்டாம்புகள் தேவை',
    stampCollected: 'சேகரிக்கப்பட்டது', stampEmpty: 'காலி',
    stampCompleted: '{n}× முடிந்தது',
    // Customer Auth
    login: 'உறுப்பினர் உள்நுழைவு', register: 'பதிவு செய்', fullName: 'முழு பெயர்',
    memberDeactivatedMsg: 'உங்கள் கணக்கு நீக்கப்பட்டுள்ளது. வணிகரை தொடர்புகொள்ளவும்.',
    // Dashboard
    ...
    redeemRewards: 'பரிசு மீட்டெடு', viewAllStampCards: 'அனைத்து ஸ்டாம்ப் கார்டுகளையும் பார்',
    myOrders: 'என் ஆர்டர்கள்', viewAllOrders: 'அனைத்து ஆர்டர்களையும் பார்',
    referralCommissions: 'பரிந்துரை கமிஷன்', myReferralProgram: 'என் பரிந்துரை திட்டம்',
    transactionHistory: 'பரிவர்த்தனை வரலாறு', logout: 'வெளியேறு', submitComplaint: 'புகார் தெரிவி',
    // My Orders page
    loginRequired: 'உறுப்பினர் உள்நுழைவு தேவை', loginToViewOrders: 'ஆர்டர் வரலாறு பார்க்க உள்நுழையவும்.',
    goToLogin: 'உறுப்பினர் உள்நுழைவுக்கு செல்',
    filterAll: 'அனைத்தும்', filterPending: 'நிலுவையில்', filterPreparing: 'தயாரிக்கிறோம்', filterDone: 'முடிந்தது',
    // Top Up page
    topUpWallet: 'வாலட் நிரப்பு', myWallet: 'என் வாலட்', bonusIncluded: 'போனஸ் சேர்க்கப்பட்டது',
    topUpBonusTitle: 'நிரப்பு போனஸ்!', topUpBonusDesc: 'RM100 நிரப்பி RM120 கிரெடிட் பெறுங்கள் (இலவச RM20!)',
    selectTopUpAmount: 'நிரப்பு தொகையை தேர்ந்தெடுக்கவும்', topUpGet: 'பெறுங்கள்', noBonus: 'போனஸ் இல்லை',
    bestDeal: 'சிறந்த டீல்', free: 'இலவசம்',
    orCustomAmount: 'அல்லது தனிப்பயன் தொகை உள்ளிடவும் (RM)',
    topUpCustomHint: 'குறைந்தபட்சம் RM10. RM100 மற்றும் அதற்கு மேல் போனஸ் பெறலாம்.',
    youPay: 'நீங்கள் செலுத்துவது', youGet: 'நீங்கள் பெறுவது', bonusLabel: 'போனஸ்',
    confirmTopUp: 'நிரப்புதலை உறுதிப்படுத்து', walletHistory: 'வாலட் வரலாறு',
    walletBalance: 'இருப்பு',
    // Wallet dashboard
    availableBalance: 'கிடைக்கும் இருப்பு', totalToppedUp: 'மொத்த நிரப்பிய தொகை', totalBonusEarned: 'மொத்த போனஸ்',
    // Tier hint
    sinceLabel: 'இருந்து',
    pointsToReach: '{tier} அடைய {n} புள்ளிகள் தேவை!',
    highestTier: '🏆 நீங்கள் உயர்ந்த நிலையை அடைந்தீர்கள்!',
    tierNameSilver: 'வெள்ளி', tierNameGold: 'தங்கம்', tierNamePlatinum: 'பிளாட்டினம்',
    // Upload
    screenshotUploaded: 'ஸ்கிரீன்ஷாட் பதிவேற்றப்பட்டது. வணிகர் சரிபார்ப்புக்காக காத்திருக்கிறது.',
    screenshotUploaded2: 'ஸ்கிரீன்ஷாட் பதிவேற்றப்பட்டது', tapToChange: 'மாற்ற தொடவும்',
    topupSubmitted: '✅ டாப்-அப் கோரிக்கை சமர்ப்பிக்கப்பட்டது! வணிகர் ஒப்புதலுக்காக காத்திருக்கிறது.',
    selectTableFirst: 'முதலில் மேசையை தேர்ந்தெடுக்கவும்!',
    photoUnder5MB: 'புகைப்படம் 5MB க்கு குறைவாக இருக்க வேண்டும்',
    noPromos: 'தற்போது ப்ரோமோக்கள் இல்லை',
    noComplaintsYet: 'இன்னும் புகார்கள் சமர்ப்பிக்கப்படவில்லை',
    mPhComplaintDesc: 'உங்கள் பிரச்சனையை விரிவாக விவரிக்கவும்...',
    mPhComplaintOrderId: 'எ.கா. ORD123456',
    enterValidRate: 'சரியான விகிதம் உள்ளிடவும் (1–100)',
    T: 'T',
    div: 'div',
    input: 'input',
    m: 'm',
    mDeactivateBtn: 'முடக்கு',
    mDeactivateMember: 'அங்கத்தினரை முடக்கு',
    mEnterValidBill: 'சரியான பில் உள்ளிடவும்',
    mFreeCoffee: 'இலவச காபி',
    mMemberInactive: 'அங்கத்தினர் செயலற்ற',
    mNoMembersYet: 'இன்னும் உறுப்பினர்கள் இல்லை',
    mOrderPickup: 'ஆர்டர் பிக்அப்',
    mOrderPrepare: 'ஆர்டர் தயாராகிறது',
    mOrderTakeaway: 'ஆர்டர் டேக்அவே',
    mPoints: 'புள்ளிகள்',
    mQRPrint: 'QR அச்சிடவும்',
    mQRTable: 'மேசை QR குறியீடு',
    backHome: 'முகப்பிற்குத் திரும்பு',
    bankAccountDisplay: 'வங்கிக் கணக்கு',
    commission_rate: 'தரகு விகிதம்',
    credited_to_referrer_s_wallet_after_first_order: 'முதல் ஆணைக்குப் பிறகு பரிந்துரைக்கும் பணப்பையில் வரவு',
    customer_complaints: 'வாடிக்கையாளர் புகார்கள்',
    enter_your_referrer_s_phone_number_to_link_commissions: 'தரகை இணைக்க உங்கள் பரிந்துரைக்கும் தொலைபேசி எண்ணை உள்ளிடவும்',
    friends_referred: 'நண்பர்கள் பரிந்துரைக்கப்பட்டனர்',
    generate_qr_codes: 'QR குறியீடுகளை உருவாக்கவும்',
    generate_table_qr_codes: 'மேசை QR குறியீடுகளை உருவாக்கவும்',
    in_progress: 'செயல்பாட்டில் உள்ளது',
    kitchen_display: 'சமையலறை காட்சி',
    member_stamp_progress: 'முத்திரை முன்னேற்றம்',
    member_wallet_balances: 'பணப்பையின் மீதி',
    merchantNameDisplay: 'வர்த்தகர் பெயர்',
    new: 'புதிய',
    no_friends_referred_yet: 'இன்னும் நண்பர்கள் பரிந்துரைக்கப்படவில்லை',
    no_pending_payment_proofs: 'நிலுவையில் பணம் செலுத்தும் ஆதாரங்கள் இல்லை',
    no_pending_requests: 'நிலுவையில் கோரிக்கைகள் இல்லை',
    number_of_tables: 'மேசைகளின் எண்ணிக்கை',
    pending_payment_proofs: 'நிலுவையில் பணம் செலுத்தும் ஆதாரங்கள்',
    pending_top_up_requests: 'நிலுவையில் டாப்-அப் கோரிக்கைகள்',
    refresh: 'புதுப்பி',
    resolved: 'தீர்க்கப்பட்டது',
    search_for_a_member: 'உறுப்பினரைத் தேடவும்',
    takeaway: 'வெளியே எடுத்துச் செல்',
    tierGold: 'தங்க',
    ...
    will_earn: 'பெறும்',
    selectMenuItem: 'மெனு உணவை தேர்ந்தெடுக்கவும்',
    enterPhoneNumber: 'உங்கள் தொலைபேசி எண்ணை உள்ளிடவும்',
    memberNotFound: 'உறுப்பினர் இல்லை. முதலில் பதிவு செய்யவும்.',
    noUnclaimedRewards: 'கோரப்படாத வெகுமதிகள் இல்லை',
    enterCardName: 'கார்டு பெயர் உள்ளிடவும்',
    enterRewardValue: 'வெகுமான மதிப்பை உள்ளிடவும்',
    minimumTopup: 'குறைந்தபட்ச டாப்-அப் RM10',
    selectTopupAmount: 'டாப்-அப் தொகையை தேர்ந்தெடுக்கவும்',
    sessionExpired: 'அமர்வு முடிந்தது, மீண்டும் தொலைபேசி எண் உள்ளிடவும்',
    memberNotFoundShort: 'உறுப்பினர் இல்லை',
    pleaseLoginFirst: 'முதலில் உறுப்பினர் உள்நுழைவு செய்யவும்',
    pleaseDescribeIssue: 'உங்கள் பிரச்சனையை விவரிக்கவும்',
    enterPhoneToLogin: 'தொலைபேசி எண் உள்ளிடவும்',
    memberNotFoundRegister: 'உறுப்பினர் இல்லை. பதிவு செய்யவும்.',
    fillNamePhone: 'பெயர் மற்றும் தொலைபேசி எண் நிரப்பவும்',
    phoneRegistered: 'தொலைபேசி எண் ஏற்கனவே பதிவாகியுள்ளது!',
    registeringAsMember: 'நீங்கள் இந்த வணிகரின் உறுப்பினராக பதிவு செய்கிறீர்கள்',
    referrerNotFound: 'பரிந்துரைப்பவர் இல்லை. தொலைபேசி எண்ணை சரிபார்க்கவும்.',
    notEnoughPoints: 'போதுமான புள்ளிகள் இல்லை!',
    invalidCredentials: 'தவறான தகவல்கள்!',
    enterPhoneSearch: 'தொலைபேசி எண் உள்ளிடவும்',
    memberNotFoundExcl: 'உறுப்பினர் இல்லை!',
    enterValidBill: 'சரியான பில் தொகை உள்ளிடவும்',
    fillNamePrice: 'பெயர் மற்றும் விலை நிரப்பவும்',
    qrNotReady: 'QR இன்னும் தயாராகவில்லை',
    complaintSubmitted: '✅ புகார் சமர்ப்பிக்கப்பட்டது! நாங்கள் விரைவில் தொடர்புகொள்வோம்.',
    // Complaint form
    submitComplaint: 'புகார் தெரிவி',
    submitComplaintBtn: 'புகாரை சமர்ப்பி',
    newComplaint: 'புதிய புகார்',
    complaintCategory: 'புகார் வகை',
    food_quality: 'உணவு தரம்',
    other: 'மற்றவை',
    pricing_issue: 'விலை பிரச்சனை',
    ...
    uploadPhotoOptional: 'புகைப்படம் பதிவேற்று (விருப்பம்)',
    tap_to_upload_photo: 'புகைப்படம் பதிவேற்ற தட்டவும்',
    photo_upload_hint: 'JPG, PNG 5MB வரை',
    order_id_optional: 'ஆர்டர் ID (விருப்பம்)',
    myComplaints: 'என் புகார்கள்',
    // Dynamic render strings
    stampCollectedMsg: 'ஸ்டாம்ப் சேகரிக்கப்பட்டது!',
    stampCollectedDetail: 'பரிசைப் பெற உங்கள் கார்டைப் பார்க்கவும்',
    walletTopupPending: 'வணிகர் ஒப்புதலுக்காக காத்திருக்கிறது',
    myOrdersEmpty: 'ஆர்டர்கள் கிடைக்கவில்லை',
    myOrdersNoOrdersYet: 'இன்னும் ஆர்டர்கள் இல்லை',
    walletTxnsEmpty: 'வாலட் பரிவர்த்தனைகள் இல்லை',
    txnNoTransactions: 'இன்னும் பரிவர்த்தனைகள் இல்லை',
    topupHistoryEmpty: 'டாப்-அப் வரலாறு இல்லை',
    complaintsEmpty: 'புகார்கள் கிடைக்கவில்லை',
    ...
    orderDetailItems: 'ஆர்டர் பொருட்கள்',
    orderDetailSubtotal: 'துணை மொத்தம்',
    orderDetailTax: 'SST',
    walletTopupLabel: 'டாப்-அப்',
    paymentCash: 'ரொக்கம்',
    paymentTng: 'Touch & Go',
    paymentBank: 'வங்கி மாற்றம்',
    statusPending: 'நிலுவையில்',
    statusPreparing: 'தயாரிக்கிறோம்',
    statusDone: 'முடிந்தது',
    stampRedeemTitle: 'வாழ்த்துக்கள்!',
    stampRedeemMsg: 'நீங்கள் அனைத்து ஸ்டாம்புகளையும் சேகரித்தீர்கள்!',
    stampRedeemClaim: 'பரிசு பெறு',
    stampRedeemLater: 'பிறகு',
    newItemsTitle: 'LoyalBrew இல் புதிது!',
    newItemsMsg: 'நீங்களுக்காக புதிய வெளியீடுகள் 🎉',
    newItemsOrderNow: 'இப்போது ஆர்டர்',
    newItemsClose: 'மூடு',
    referralReferral: 'பரிந்துரை புரோகிராம்',
    referralInviteFriends: 'நண்பர்களை அழையுங்கள், கமிஷன் சம்பாதியுங்கள்!',
    referralShareCode: 'உங்கள் தொலைபேசி எண்ணை பரிந்துரை குறியீடாகப் பகிருங்கள். உங்கள் நண்பர் முதல் ஆர்டர் செய்யும்போது, உங்கள் வாலட்டில் கமிஷன் கிடைக்கும்!',
    referralCopyCode: 'நகல்',
    referralFriendsReferred: 'பரிந்துரைத்த நண்பர்கள்',
    referralTotalEarned: 'மொத்தம் சம்பாதித்தது',
    referralCommissionRate: 'கமிஷன் வீதம்',
    referralCommissionHistory: 'கமிஷன் வரலாறு',
    referralFriendsYouReferred: 'நீங்கள் பரிந்துரைத்த நண்பர்கள்',
    referralNoCommissions: 'இன்னும் கமிஷன்கள் இல்லை. பரிந்துரைக்கத் தொடங்குங்கள்!',
    referralNoFriends: 'இன்னும் நண்பர்கள் பரிந்துரைக்கப்படவில்லை.',
    complaintSubmitComplaint: 'புகார் சமர்ப்பி',
    complaintCategory: 'புகார் வகை',
    complaintDescription: 'விளக்கம்',
    complaintUploadPhoto: 'புகைப்படம் பதிவேற்று (விரும்பினால்)',
    complaintTapUpload: 'புகைப்படம் பதிவேற்ற கிளிக்',
    complaintOrderIdOpt: 'ஆர்டர் எண் (விரும்பினால்)',
    complaintSubmit: 'புகார் சமர்ப்பி',
    complaintMyComplaints: 'என் புகார்கள்',
    complaintComplaintDetail: 'புகார் விவரம்',
    ...
    card_name_placeholder: 'உதாரணம்: 10 ஸ்டாம்ப்கள் சேகரிக்கவும்',
    cash: 'ரொக்கம்',
    category: 'வகை',
    cleanliness: 'தூய்மை',
    ...
    complaint_detail: 'புகார் விவரங்கள்',
    complaints: 'புகார்கள்',
    confirm_deactivate: 'முடக்கத்தை உறுதிப்படுத்து',
    create_account: 'கணக்கு திரும்ப',
    create_stamp_card: 'ஸ்டாம்ப் கார்டை உருவாக்கு',
    deactivate_member: 'உறுப்பினரை முடக்கு',
    description: 'விளக்கம்',
    desserts: 'இனிப்புகள்',
    done: 'முடிந்தது',
    emoji_icon: 'இமோஜி ஐகான்',
    end_date: 'முடிவு தேதி',
    enter_your_referrer_s_phone_number_to_link_commissions: 'கமிஷன்களை இணைக்க பரிந்துரைக்கும் தொலைபேசி எண்ணை உள்ளிடவும்',
    ...
    kitchen: 'சமையல் அறை',
    launch_date: 'வெளியீட்டு தேதி',
    launch_new_item: 'புதிய பொருளை வெளியிடு',
    login_to_dashboard: 'டாஷ்போர்டுக்கு உள்நுழைய',
    members: 'உறுப்பினர்கள்',
    menu_items: 'மெனு பொருட்கள்',
    merchant: 'வணிகர்',
    merchant_login: 'வணிகர் உள்நுழைய',
    new_complaint: 'புதிய புகார்',
    no_active_new_items: 'செயலில் உள்ள புதிய பொருட்கள் இல்லை',
    no_past_launches: 'முந்தைய வெளியீடுகள் இல்லை',
    no_pickup_time_set: 'பிக்கப் நேரம் அமைக்கப்படவில்லை',
    ...
    overview: 'மேலோட்டம்',
    password: 'கடவுச்சொல்',
    past_launches: 'முந்தைய வெளியீடுகள்',
    pending: 'காத்திருக்கும்',
    ...
    save_password: 'கடவுச்சொல் சேமி',
    select_menu_item: 'மெனு பொருளைத் தேர்வுசெய்',
    settings: 'அமைப்புகள்',
    snacks: 'சிற்றுண்டி',
    stamp_cards: 'ஸ்டாம்ப் கார்டுகள்',
    stamp_rule: 'ஸ்டாம்ப் விதி',
    stamp_rule_placeholder: 'உதாரணம்: RM10 செலவு = 1 ஸ்டாம்ப்',
    ...
    referralSharePrompt: 'உங்கள் தொலைபேசி {phone} ஐ பரிந்துரை குறியீடாக பகிர்ந்து, நண்பர்களின் முதல் ஆர்டரிலிருந்து {rate}% சம்பாதியுங்கள்!',
    // Ads
    ads: 'விளம்பரங்கள்',
    create_ad: 'புதிய விளம்பரம் உருவாக்கு',
    ad_title: 'விளம்பர தலைப்பு',
    ad_link: '�ணைப்பு URL (விருப்பம்)',
    start_date: 'தொடக்க தேதி',
    end_date: 'முடிவு தேதி',
    ad_image: 'விளம்பர படம்',
    click_to_upload_ad_image: 'விளம்பர படத்தை பதிவேற்ற கிளிக் செய்யவும்',
    ad_position: 'காட்சி நிலை',
    ad_priority: 'முன்னுரிமை',
    higher_shows_first: 'அதிக எண் = முதலில் காட்டு',
    active_ads: 'செயலில் உள்ள விளம்பரங்கள்',
    no_active_ads: 'செயலில் விளம்பரங்கள் இல்லை',
    all_ads: 'அனைத்து விளம்பரங்கள்',
    no_ads_yet: 'இன்னும் விளம்பரங்கள் இல்லை',
    ad_statistics: 'விளம்பர புள்ளிவிவரம்',
    landing_page_top: 'முகப்பு பக்கம் மேலே',
    promosAndDeals: 'சலுகைகள் & சலுகை விலைகள்',
    viewAllPromos: 'அனைத்து சலுகைகளையும் பார்',
    allPromos: 'அனைத்து சலுகைகள்',
    noPromosNow: 'தற்போது சலுகைகள் இல்லை. மீண்டும் வாருங்கள்!',
 
    welcomeBack: 'மீண்டும் வரவேற்கிறோம்',
    drinkToday: 'இன்று என்ன குடிக்கிறீர்கள்?',
    firebaseNote: 'முக்கிய பொத்தான் Firebase-ஐ இணைக்கும்: வர்த்தகர் கடன்களைச் சரிபார்க்கவும், வெற்றிக்குப் பின் 1ஐ தானாகக் கழிக்கும்.',
    enter: 'நுழை',
    get: 'பெறு',
    view: 'பார்',
    back: 'திரும்ப',
    ...
    menuMgmt2: 'பட்டியல் மேலாண்மை',
    shopSettings2: 'கடை அமைப்புகள்',
    kitchenDisplay2: 'சமையலறை காட்சி',
    confirmPoints: 'புள்ளிகளை உறுதிப்படுத்து',
    topUpGateway: 'மீண்டும் நிரப்பு (கட்டண வாயில்)',
    shopInfo: 'கடை தகவல்',
    shopName: 'கடை பெயர்',
    announcement: 'அறிவிப்பு',
    bannerUrl: 'பேனர் பட URL',
    saveShop: 'கடைத் தகவலைச் சேமி',
    pointsSettings: 'புள்ளிகள் அமைப்புகள்',
    pointsPerRM: 'RM ஒவ்வொன்றுக்கும் புள்ளிகள்',
    savePoints2: 'புள்ளிகள் அமைப்புகளைச் சேமி', 
    welcomeBack: 'மீண்டும் வரவேற்கிறோம்',
    drinkToday: 'இன்று என்ன குடிக்கிறீர்கள்?',
    firebaseNote: 'முக்கிய பொத்தான் Firebase-ஐ இணைக்கும்: வர்த்தகர் கடன்களைச் சரிபார்க்கவும், வெற்றிக்குப் பின் 1ஐ தானாகக் கழிக்கும்.',
    enter: 'நுழை',
...
function setLang(lang) {
  ...
  document.querySelectorAll('.lang-btn').forEach(b => {
    b.classList.toggle('active', b.textContent.trim() === { en:'EN', zh:'中文', ms:'BM', ta:'தமிழ்' }[lang]);
  });
...
const DEFAULT_MENU = [
  // 曼煎糕 Pan Cake
  { id: 'as_pan_cake_pandan',   name: '曼煎糕 (班兰) Pan Cake Pandan',     emoji: '🥞', price: 1.60, category: 'Traditional Cakes', desc: '香浓班兰味曼煎糕，一片', image: 'menu_photos/pancake.jpg' },
  { id: 'as_pan_cake_brownsugar',name: '曼煎糕 (黑糖) Pan Cake Brown Sugar',emoji: '🥞', price: 1.60, category: 'Traditional Cakes', desc: '黑糖味曼煎糕，一片', image: 'menu_photos/pancake.jpg' },
  { id: 'as_pan_cake_box',      name: '曼煎糕 一盒 (11片) Big Plate',       emoji: '📦', price: 16.00,category: 'Traditional Cakes', desc: '整盒曼煎糕，11片装', image: 'menu_photos/pancake.jpg' },
  // 花生麻糬 Peanut Mochi
  { id: 'as_peanut_mochi',      name: '花生麻糬 Peanut Mochi (一盒)',       emoji: '🥜', price: 5.50, category: 'Mochi', desc: '原味花生麻糬，香甜软糯', image: 'menu_photos/peanut-mochi.jpg' },
  // 雪媚娘 Snow Mochi - RM4.50
  { id: 'as_snow_mochi_mango',      name: '雪媚娘 (芒果) Snow Mochi',          emoji: '🥭', price: 4.50, category: 'Mochi', desc: '新鲜芒果馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_oreo',       name: '雪媚娘 (奥利奥) Snow Mochi',       emoji: '🍪', price: 4.50, category: 'Mochi', desc: '奥利奥馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_banana_choco',name:'雪媚娘 (香蕉巧克力) Snow Mochi',  emoji: '🍌', price: 4.50, category: 'Mochi', desc: '香蕉巧克力馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_brown_sugar', name:'雪媚娘 (黑糖珍珠) Snow Mochi',     emoji: '🫗', price: 4.50, category: 'Mochi', desc: '黑糖珍珠馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  // 雪媚娘 Snow Mochi - RM5.00
  { id: 'as_snow_mochi_icecream',   name: '雪媚娘 (冰淇淋) Snow Mochi',       emoji: '🍨', price: 5.00, category: 'Mochi', desc: '冰淇淋馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_longan',     name: '雪媚娘 (龙眼) Snow Mochi',         emoji: '👁️', price: 5.00, category: 'Mochi', desc: '龙眼馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_strawberry',  name: '雪媚娘 (草莓) Snow Mochi',         emoji: '🍓', price: 5.00, category: 'Mochi', desc: '新鲜草莓馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_chocolate',   name: '雪媚娘 (巧克力) Snow Mochi',       emoji: '🍫', price: 5.00, category: 'Mochi', desc: '浓郁巧克力馅雪媚娘', image: 'menu_photos/snow-mochi.jpg' },
  // 葡式蛋挞 Portuguese Egg Tarts
  { id: 'as_egg_tart',           name: '葡式蛋挞 Portuguese Egg Tart',      emoji: '🥧', price: 3.50, category: 'Pastries', desc: '酥脆葡式蛋挞，一粒', image: 'menu_photos/egg-tart.jpg' },
];
...
function saveShopSettings() {
  ...
  showToast('Shop info saved! / 店铺信息已保存');
  // Sync to Firestore
  const fb = window.__lbFirebase;
...
function getPointsSettings() {
  return safeLS.json(_getMerchantStorageKey(POINTS_SETTINGS_KEY) || '{"rate":1}');
}

function savePointsSettings() {
  const rate = parseFloat(document.getElementById('m-points-rate')?.value) || 1;
  const settings = { rate, updatedAt: new Date().toISOString() };
  safeLS.setJSON(_getMerchantStorageKey(POINTS_SETTINGS_KEY), settings);
  showToast('Points settings saved! / 积分设置已保存');
  // Sync to Firestore
  const fb = window.__lbFirebase;
  const merchantId = window._currentMerchantId;
  if (fb?.db && fb?.doc && fb?.updateDoc && merchantId) {
...
function showPage(id) {
  ...
  if (id === 'page-landing') { renderAdCarousel(); }
...
async function loadMerchantCredits() {
  // 安全校验：等待 Firebase Auth 初始化完成
  const fb = window.__lbFirebase;
  
  // 等待 auth 初始化（最多等待 3 秒）
  let attempts = 0;
  ...
  const userEmail = currentUser?.email || '(未登录)';
  const localUser = document.getElementById('m-user')?.value?.trim();

  // 只有 Firebase achstar02@gmail.com 或本地 admin 登录才能读取
  ...
  // 已放开 Firebase Rules，直接读取 merchants 集合
  try {
    let rows = [];
...
function openTopUpPlaceholder() {
  showToast('充值功能占位：即将对接支付网关（RM15 / RM40 / RM100）', 'success');
}
    ...
    listEl.innerHTML = cart.map(item => `
      <div class="cart-item">
        ...
        <div class="cart-item-right">
          ...
          <button class="remove-btn" onclick="removeCartItem('${item.id}')"><i class="fas fa-trash"></i> ${t('removeItem')}</button>
        </div>
      </div>
    `).join('');
    updateCartSummary();
...
function placeOrder() {
  ...
  showToast(orderType === 'takeaway' ? '🛍️ Takeaway order placed!' : '🍳 Order sent to kitchen!');
}
...
function openProofImage(proofId) {
  ...
  w.document.write(`<html><body style="margin:0;background:#000"><img src="${p.proofImage}" style="max-width:100%;max-height:100vh;display:block;margin:auto"></body></html>`);
}
...
function openStampRedeemModal(cardId, memberId) {
  ...
  if (card.rewardType === 'free_item') {
    ...
    rewardHtml = `<div style="font-size:2.8rem;margin:12px 0">🏷️</div>
    ...
    return `
      <div class="member-row" style="flex-wrap:wrap;gap:8px">
        ...
        <div style="display:flex;gap:8px;align-items:center">
          <button class="btn-sm" style="background:#2e7d32;color:white" onclick="approveTopup('${r.id}')"><i class="fas fa-check"></i> ${mt('mApprove')}</button>
          <button class="btn-sm" style="background:#c62828;color:white" onclick="rejectTopup('${r.id}')"><i class="fas fa-times"></i> ${mt('mReject')}</button>
        </div>
      </div>`;
  }).join('');
}
  ...
  el.innerHTML = complaints.map(c => {
    ...
    return `
      <div class="complaint-card">
        ...
        ${c.response ? `<div class="complaint-response-box"><i class="fas fa-reply"></i> <em>${escHtml(c.response)}</em></div>` : ''}
        <div style="font-size:0.72rem;color:#aaa;margin-top:6px">${d} · #${escHtml(c.id)}</div>
      </div>
    `;
  }).join('');
}
...
function openOrderDetail(orderId) {
  ...
  document.getElementById('order-detail-content').innerHTML = `
    <div style="background:#f9f9f9;border-radius:10px;padding:12px;margin-bottom:10px">
      ...
      <p><strong>Type:</strong> ${order.orderType === 'takeaway' ? '🛍️ Takeaway' : `🪑 Dine In (Table ${order.tableNo})`}</p>
  ...
  if (tab === 'register') {
    try {
      ...
      if (_mInfo && typeof MERCHANT_DOC_PATH !== 'undefined' && MERCHANT_DOC_PATH.id) {
        // 优先从全局变量取，其次 localStorage shopSettings，再次尝试 Firestore
...
function customerRegister() {
  ...
  const newMember = {
    ...
    referrerId,
    hasFirstOrder: false,
    merchantId: mid,  // Tag this member to the current merchant
  };
...
function renderCustomerTxns(memberId) {
  ...
  if (txns.length === 0) { list.innerHTML = `<p style="color:#aaa;text-align:center;padding:16px">${_t('txnNoTransactions') || '暂无记录'}</p>`; return; }
...
// ──────────────────────────────────────────────
// 安全包装：确保 Firebase 就绪后才调用 loadMerchantCredits
// 防止 "Firebase 未初始化" 错误
// ──────────────────────────────────────────────
...
// ──────────────────────────────────────────────
// 安全包装：确保 Firebase 就绪后才弹出超级管理员登录框
// ──────────────────────────────────────────────
...
function initSuperAdminMode() {
  // 优先检查 Firebase Auth email，fallback 到本地商家用户名和 localStorage
...
// ===== renderSuperAdminMerchantsList — 渲染商家表格到 #sa-list =====
async function renderSuperAdminMerchantsList() {

  // 防御性：确保 sa-summary 和 sa-list 元素存在
      ...
      mainContent.innerHTML = `
        <div style="padding:20px;max-width:1000px;margin:0 auto">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
            <h2 style="margin:0">👑 超级管理员 — 商家 Credits 管理</h2>
            <button onclick="showPage('page-customer')" style="padding:8px 16px;border:none;background:#eee;border-radius:8px;cursor:pointer">返回主页</button>
          </div>
  ...
  const fb = window.__lbFirebase;
  if (!fb?.db) {
    summaryEl.textContent = 'Firestore 未就绪';
    listEl.innerHTML = '<div style="padding:30px;color:#c62828;text-align:center">请检查网络连接</div>';
    return;
  }
  ...
  try {
    ...
    const merchants = rows
      .filter(m => m.status !== 'deleted')  // 过滤已软删除的商家
      .map(m => ({ id: m.id, name: String(m.merchant_name || '未命名'), credits: Number(m.credits) || 0, promoEnabled: !!m.promoEnabled }))
      .sort((a, b) => b.credits - a.credits);

    const totalCredits = merchants.reduce((s, m) => s + m.credits, 0);
    summaryEl.textContent = `共 ${merchants.length} 个商家 · 总 Credits: ${totalCredits}`;
    ...
    if (merchants.length === 0 && deletedMerchants.length === 0) {
      listEl.innerHTML = '<div style="padding:30px;color:#aaa;text-align:center">暂无商家数据</div>';
      return;
    }

    listEl.innerHTML = `
      <div style="display:grid;grid-template-columns:1.5fr 1fr 0.5fr 0.6fr 2fr;background:#f7f7f7;padding:12px 16px;font-weight:700;font-size:0.82rem;border-bottom:2px solid #ddd">
        <div>商家名称</div><div>ID</div><div style="text-align:center">促销</div><div style="text-align:right">Credits</div><div style="text-align:center">操作</div>
      </div>
      ${merchants.map((m, i) => {
        const promoOn = !!m.promoEnabled;
        const custUrl = 'https://loyalbrew-app-2f8c7.web.app/?m=' + m.id;
        return `
        <div style="display:grid;grid-template-columns:1.5fr 1fr 0.5fr 0.6fr 2fr;padding:12px 16px;border-bottom:1px solid #f1f1f1;align-items:center;${i % 2 === 1 ? 'background:#fafafa;' : ''}">
          ...
          <div style="display:flex;gap:4px;flex-wrap:wrap;justify-content:center">
            <a href="${custUrl}" target="_blank" style="color:#1976d2;text-decoration:none;font-size:0.75rem;background:#e3f2fd;padding:4px 10px;border-radius:6px;border:1px solid #bbdefb;display:inline-block">🔗 顾客链接</a>
            <button onclick="_saShowQR('${escHtml(m.name)}','${m.id}')" style="background:#7b1fa2;color:#fff;border:none;padding:4px 10px;border-radius:6px;cursor:pointer;font-size:0.75rem">📱 QR码</button>
            <button onclick="_saOpenTopup('${m.id}', ${m.credits})" style="background:#1b5e20;color:#fff;border:none;padding:4px 10px;border-radius:6px;cursor:pointer;font-size:0.75rem">💰 充值</button>
            <button onclick="_saDeactivateMerchant('${m.id}', '${escHtml(m.name)}')" style="background:#b91c1c;color:#fff;border:none;padding:4px 10px;border-radius:6px;cursor:pointer;font-size:0.75rem">🗑 删除</button>
          </div>
        </div>`;
      }).join('')}
      ${deletedMerchants.length > 0 ? `
      <div style="margin-top:28px;padding:0 4px">
        <div style="font-size:0.82rem;font-weight:700;color:#b91c1c;margin-bottom:10px;display:flex;align-items:center;gap:8px">🗑 已解除商家（${deletedMerchants.length}个，可恢复）</div>
        <div style="display:grid;grid-template-columns:1.5fr 1fr 0.5fr 0.6fr 2fr;background:#f7f7f7;padding:12px 16px;font-weight:700;font-size:0.82rem;border-bottom:2px solid #ddd">
          <div>商家名称</div><div>ID</div><div style="text-align:center">促销</div><div style="text-align:right">Credits</div><div style="text-align:center">操作</div>
        </div>
        ${deletedMerchants.map((m, i) => `
          <div style="display:grid;grid-template-columns:1.5fr 1fr 0.5fr 0.6fr 2fr;padding:12px 16px;border-bottom:1px solid #f1f1f1;align-items:center;${i % 2 === 1 ? 'background:#fff5f5;' : 'background:#fff8f8;'}">
            ...
            <div style="display:flex;gap:4px;flex-wrap:wrap;justify-content:center">
              <a href="https://loyalbrew-app-2f8c7.web.app/?m=${m.id}" target="_blank" style="color:#1976d2;text-decoration:none;font-size:0.75rem;background:#e3f2fd;padding:4px 10px;border-radius:6px;border:1px solid #bbdefb;display:inline-block">🔗 顾客链接</a>
              <button onclick="_saShowQR('${escHtml(m.name)}','${m.id}')" style="background:#7b1fa2;color:#fff;border:none;padding:4px 10px;border-radius:6px;cursor:pointer;font-size:0.75rem">📱 QR码</button>
              <button onclick="_saRestoreMerchant('${m.id}', '${escHtml(m.name)}')" style="background:#1e40af;color:#fff;border:none;padding:4px 10px;border-radius:6px;cursor:pointer;font-size:0.75rem">↩ 恢复</button>
            </div>
          </div>
        `).join('')}
      </div>
...
// ══════════════════════════════════════════════════════
// 超级管理员强制初始化（异步，等 Firebase 就绪）
// 页面加载时，如果当前 Firebase 用户不是超级管理员，立即注销，强制重新登录
// ══════════════════════════════════════════════════════
(async () => {
  // 等待 Firebase SDK 加载（最多 5 秒）
  ...
  // 注册 listener（Firebase 会通知当前状态，包括缓存用户）
  initFirebaseAuthListener();

  // 检查缓存的当前用户 — Firebase SDK 可能会从 localStorage 恢复
  const _u = fb.auth().currentUser;
  if (_u && String(_u.email || '').toLowerCase() !== SUPER_ADMIN_EMAIL) {
    // 非超级管理员 → 强制注销

    await fb.signOut().catch(() => {});
    // 注销后自动触发 listener（状态变为 null），然后弹出登录框
...
window.showSuperAdminPage = async function() {
  ...
  const fb = window.__lbFirebase;
  if (!fb?.auth) {
    showToast('Firebase 未初始化，请稍候再试', 'error');
    return;
  }
  ...
  // ── 工具：弹出 Firebase Email 登录框 (自定义 HTML modal) ──
  function _openSuperAdminLoginModal() {
    ...
    modal.innerHTML = `
      <div style="background:#fff;border-radius:16px;padding:32px;width:360px;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.3)">
        <h2 style="margin:0 0 8px 0;font-size:1.3rem">🔐 超级管理员登录</h2>
        <p style="color:#666;font-size:0.85rem;margin:0 0 24px 0">请输入您的超级管理员邮箱和密码</p>
        ...
        <input id="sa-login-pass" type="password" placeholder="密码"
        ...
        <button onclick="_doSuperAdminLogin()"
          style="width:100%;padding:14px;background:linear-gradient(135deg,#f57c00,#ff8f00);color:#fff;border:none;border-radius:10px;font-size:1rem;font-weight:600;cursor:pointer;margin-bottom:10px">登 入</button>
        <button onclick="_cancelSuperAdminLogin()"
          style="width:100%;padding:10px;background:#f5f5f5;color:#666;border:none;border-radius:10px;font-size:0.9rem;cursor:pointer">取 消</button>
      </div>`;
  ...
  window._doSuperAdminLogin = async function() {
    ...
    try {
      ...
      showToast('登录成功，正在加载...', 'success');
      // 登录成功后，auth listener 会触发，再调一次 showSuperAdminPage
  ...
  // ══════════════════════════════════════════════════════
  // 第三步：监听 auth 状态变化（处理登录后回调）
  // ══════════════════════════════════════════════════════
  fb.auth().onAuthStateChanged((user) => {
    if (!user) return;
    const email = String(user.email || '').toLowerCase();
    if (email !== SUPER_ADMIN_EMAIL) return; // 非超级管理员不响应
  ...
  function _renderSuperAdminPage() {
    ...
    main.innerHTML = `
      <div id="super-admin-section" class="p-4" style="padding:20px;max-width:1000px;margin:0 auto">
        <h1 style="margin:0 0 16px 0">👑 商家管理总台</h1>
        <div style="margin-bottom:16px;display:flex;gap:10px;align-items:center;flex-wrap:wrap">
          <button onclick="location.reload()" style="padding:8px 16px;border:none;background:#1976d2;color:#fff;border-radius:8px;cursor:pointer">🏠 返回首页</button>
          <span id="sa-email-badge" style="font-size:0.8rem;color:#fff;background:#f57c00;padding:4px 12px;border-radius:20px"></span>
          <button onclick="window.__lbFirebase.auth().signOut().then(() => location.reload())" style="padding:8px 16px;border:none;background:linear-gradient(135deg,#c62828,#e53935);color:#fff;border-radius:8px;cursor:pointer;font-weight:600">⚡ 强制切换账号</button>
        </div>
        <div id="sa-summary" style="color:#666;margin-bottom:16px;font-size:0.9rem">加载中...</div>

        <div style="margin-bottom:16px">
          <button onclick="_saOpenRegModal()"
            style="background:linear-gradient(135deg,#15803d,#16a34a);color:#fff;border:none;padding:10px 22px;border-radius:10px;cursor:pointer;font-size:0.92rem;font-weight:600;box-shadow:0 2px 8px rgba(21,128,61,0.3)">🏪 新增商家</button>
        </div>
...
async function _loadSuperAdminMerchants() {
  const fb = window.__lbFirebase;
  if (!fb?.db) {
    document.getElementById('sa-list').innerHTML = '<div style="padding:20px;color:#c62828;text-align:center">Firestore 未就绪，请检查网络连接</div>';
    return;
  }
  try {
    let rows = [];
    ...
    document.getElementById('sa-summary').textContent = `共 ${merchants.length} 个商家 · 已解除 ${deletedMerchants.length} 个 · 超级管理员: ${SUPER_ADMIN_EMAIL}`;

    if (merchants.length === 0 && deletedMerchants.length === 0) {
      document.getElementById('sa-list').innerHTML = '<div style="padding:20px;color:#aaa;text-align:center">暂无商家数据</div>';
      return;
    }
    ...
    document.getElementById('sa-list').innerHTML = '<div style="padding:20px;color:#c62828;text-align:center">读取失败：' + e.message + '</div>';
  }
}

async function _saOpenTopup(merchantId, currentCredits) {
  const input = prompt(`💰 为商家 [${merchantId}] 充值\n当前余额: ${currentCredits}\n\n请输入充值数额（credits）:`, '50');
  if (!input || isNaN(parseFloat(input))) { showToast('已取消或输入无效', 'info'); return; }
  const amount = parseFloat(input);
  if (amount <= 0) { showToast('数额必须大于0', 'error'); return; }

  const fb = window.__lbFirebase;
  if (!fb?.db) { showToast('Firestore 未就绪', 'error'); return; }
  try {
    ...
    showToast(`✅ 充值成功！+${amount} credits`, 'success');
    await _loadSuperAdminMerchants();
  } catch(e) {
...
const MERCHANT_LANGS = {
  en: {
    ...
    mTabAds: 'Ads',
    mCreateAd: 'Create New Ad', mAdTitle: 'Ad Title', mAdLink: 'Link URL (optional)', mAdStart: 'Start Date', mAdEnd: 'End Date', mAdImage: 'Ad Image', mAdPosition: 'Display Position', mAdPriority: 'Priority', mAdPriorityHint: 'Higher number = shown first', mActiveAds: 'Active Ads', mNoActiveAds: 'No active ads', mAllAds: 'All Ads', mNoAds: 'No ads yet', mAdStats: 'Ad Statistics', mClickToUploadAd: 'Click to upload ad image',
  ...
  zh: {
    mCatHotDrinks: '热饮', mCatColdDrinks: '冷饮', mCatFood: '食品', mCatDesserts: '甜品', mCatSnacks: '小吃', mCatPromotions: '促销',
    mPromoPrice: '促销价 (RM)', mPromoPriceDesc: '可选 — 非高峰特惠',
    mUsername: '用户名', mPassword: '密码', mSavePassword: '保存密码',
    mLoginBtn: '登录后台', mKitchen: '厨房', mKitchenDisplay: '厨房显示', mRefresh: '刷新', mKitchenNew: '新订单', mKitchenPreparing: '准备中', mKitchenDone: '已完成', mTabSettings: '设置',
    mTabAds: '广告',
    mCreateAd: '创建新广告', mAdTitle: '广告标题', mAdLink: '链接 URL（可选）', mAdStart: '开始日期', mAdEnd: '结束日期', mAdImage: '广告图片', mAdPosition: '展示位置', mAdPriority: '优先级', mAdPriorityHint: '数字越大越靠前', mActiveAds: '活跃广告', mNoActiveAds: '暂无活跃广告', mAllAds: '全部广告', mNoAds: '暂无广告', mAdStats: '广告统计', mClickToUploadAd: '点击上传广告图片',
    mTabOverview: '概览', mTabOrders: '订单', mTabMenu: '菜单',
    mTabMembers: '会员', mTabNewItems: '新品', mTabStamp: '印章卡',
    mTabTopup: '充值', mTabComplaints: '投诉', mTabCommissions: '佣金', mTabQR: '二维码',
    mAddNewItem: '添加新品', mItemName: '食品名称', mItemPrice: '价格 (RM)',
    mItemCat: '类别', mItemEmoji: 'Emoji 图标', mItemDesc: '描述',
    mItemPhoto: '食品照片', mItemPhotoOpt: '（可选）', mClickToUpload: '点击上传照片',
    mRemovePhoto: '移除照片', mAddToMenu: '添加到菜单', mMenuItems: '菜单列表',
    mAllMembers: '全部会员', mRecentTxns: '近期交易',
    mDeactivateMember: '解除会员', mConfirmDeactivate: '确认解除',
    mActivateMember: '恢复会员', mConfirmActivate: '确认恢复',
    mMemberActive: '正常', mMemberInactive: '已解除',
    mDeactivateBtn: '解除会员', mActivateBtn: '恢复',
    // Overview
    mStatMembers: '会员数', mStatPoints: '已发积分', mStatOrders: '今日订单', mStatRevenue: '今日收入',
    mAddPointsManually: '手动添加积分', mPhoneNumber: '手机号码',
    mBillAmount: '账单金额 (RM)', mWillEarn: '将获得', mPoints: '积分', mAddPoints: '添加积分', mPurchase: '消费', mFreeCoffee: '免费咖啡',
    // Orders
    mAllOrders: '全部订单', mFilterAll: '全部', mFilterPending: '待处理', mFilterPreparing: '准备中', mFilterDone: '完成',
    // New Items
    mLaunchNewItem: '发布新品', mSelectMenuItem: '选择菜单食品', mChooseAnItem: '-- 选择食品 --',
    mSpecialPrice: '特价 (RM)', mOptional: '可选',
    mLaunchDate: '发布日期', mEndDate: '截止日期',
    mAnnouncementText: '公告文字',
    mActiveNewLaunches: '当前新品', mNoActiveItems: '暂无新品',
    mPastLaunches: '过去发布', mNoPastLaunches: '暂无过去发布',
    // Stamp
    mCreateStampCard: '创建印章卡', mCardName: '卡名称', mCardEmoji: '卡 Emoji / 图标',
    mStampsRequired: '完成所需印章数', mStampRule: '印章规则',
    mRulePerOrder: '每次购买 = 1 印章', mRulePerAmount: '每消费 RM X = 1 印章', mRulePerItem: '购买指定商品 = 1 印章',
    mRewardType: '奖励类型', mRewardFreeItem: '免费菜单食品', mRewardFlatDiscount: '固定折扣 (RM)',
    mRewardPctDiscount: '百分比折扣 (%)', mRewardBonusPoints: '额外积分',
    mFreeItem: '免费食品', mCardColorTheme: '卡片颜色主题',
    mActiveStampCards: '当前印章卡', mNoStampCards: '暂无印章卡',
    mMemberStampProgress: '会员印章进度', mSearchForMember: '搜索会员',
    // Top Up
    mPendingTopupRequests: '待处理充值申请', mNoPendingRequests: '暂无待处理申请',
    mTopupBonusSettings: '充值赠额设置', mAddBonusRule: '添加赠额规则',
    mMinTopupAmount: '最低充值金额 (RM)', mBonusPercent: '赠额百分比 (%)', mBonusExpiry: '截止日期',
    mAddRule: '添加规则', mDeleteRule: '删除', mExpired: '已过期', mNoExpiry: '无截止日期',
    mMinAmt: '最低 RM', mBonusPct: '赠额',
    mMemberWalletBalances: '会员钱包余额', mTopupHistory: '充值记录', mNoTopupHistory: '暂无充值记录',
    // Complaints
    mCustomerComplaints: '顾客投诉',
    mComplaintOpen: '待处理', mComplaintInProgress: '处理中', mComplaintResolved: '已解决',
    // QR
    mGenerateQR: '生成桌号二维码', mQRHint: '每桌一个二维码，顾客扫码直接点餐。',
    mNumberOfTables: '桌子数量',
    // Commissions
    mCommissionSettings: '佣金设置', mReferralCommissionRate: '推荐佣金比例',
    mCommissionDesc: '推荐人从被推荐人首单总额中赚取百分比',
    mCurrentRate: '当前比例：', mCommissionCredited: '首单后自动入账推荐人钱包。',
    mPendingPaymentProofs: '待审核付款凭证', mNoPaymentProofs: '暂无待审核付款凭证',
    mCommissionRecords: '佣金记录',
    mVerify: '审核通过', mReject: '拒绝', mApprove: '批准',
    mPaymentVerified: '付款已审核 ✅',
    mPaymentRejected: '付款凭证已拒绝。',
    mNoCommissions: '暂无佣金记录',
    mFirstOrderDone: '✅ 已完成首单', mNotOrderedYet: '⏳ 尚未下单',
    mTopupSubmitted: '✅ 充值申请已提交！等待商家审核。',
    mTopupApproved: '已批准！已入账', mTopupRejected: '申请已拒绝。',
    mScreenshotUploaded: '截图已上传，等待商家审核。',
    ...
    mStampPerPurchase: '每次消费 = 1 印章', mStampPerRM: '每消费 RM', mStampPerItem: '每个指定食品 = 1 印章',
    mStampsLabel: '个印章',
    mNoStampCardsYet: '暂无印章卡', mNoMembersYet: '暂无会员', mNoOrdersFound: '没有找到订单',
    mNoTransactions: '暂无交易记录', mNoMembersFound: '没有找到会员', mNoComplaintsFound: '没有找到投诉',
    mNiSpecial: '特价：RM', mNiWas: '原价 RM', mNiLaunch: '发布日期：', mNiEnds: '截止：', mNiNoEndDate: '无截止日期',
    mNiDeactivate: '下架', mNiDelete: '删除',
    mBalance: '余额',
    mOrderPrepare: '准备中', mOrderDone: '完成',
    mOrderTakeaway: '外卖', mOrderTable: '桌号', mOrderPickup: '取餐',
    mOrderCompleted: '订单已完成！✅', mOrderMovedPreparing: '已移至准备中！',
    mComplaintNoPhoto: '有附件照片', mDetailCustomer: '顾客', mDetailCategory: '类别',
    mDetailStatus: '状态', mDetailOrder: '订单', mDetailDate: '日期', mDetailPrevResponse: '之前的回复',
    mComplaintResolved: '投诉已标记为已解决 ✅',
    ...
    mCatHotDrinks: 'சூடான பானங்கள்', mCatColdDrinks: 'குளிர் பானங்கள்', mCatFood: 'உணவு', mCatDesserts: 'இனிப்புகள்', mCatSnacks: 'சிற்றுண்டி', mCatPromotions: 'விளம்பரங்கள்',
    mPromoPrice: 'விளம்பர விலை (RM)', mPromoPriceDesc: 'விருப்பமானது — off-peak சிறப்பு',
    mUsername: 'பயனர் பெயர்', mPassword: 'கடவுச்சொல்', mSavePassword: 'கடவுச்சொல் சேமி',
    mLoginBtn: 'டாஷ்போர்டுக்கு உள்நுழை', mKitchen: 'சமையலறை', mKitchenDisplay: 'சமையலறை காட்சி', mRefresh: 'புதுப்பி', mKitchenNew: 'புதியது', mKitchenPreparing: 'தயாராகிறது', mKitchenDone: 'முடிந்தது', mTabSettings: 'அமைப்புகள்',
    mTabAds: 'விளம்பரங்கள்',
    mCreateAd: 'புதிய விளம்பரம் உருவாக்கு', mAdTitle: 'விளம்பர தலைப்பு', mAdLink: 'URL இணைப்பு (விருப்பம்)', mAdStart: 'தொடக்க தேதி', mAdEnd: 'முடிவு தேதி', mAdImage: 'விளம்பர படம்', mAdPosition: 'காட்சி நிலை', mAdPriority: 'முன்னுரிமை', mAdPriorityHint: 'அதிக எண் = முதலில் காட்டு', mActiveAds: 'செயலில் விளம்பரங்கள்', mNoActiveAds: 'செயலில் விளம்பரங்கள் இல்லை', mAllAds: 'அனைத்து விளம்பரங்கள்', mNoAds: 'இன்னும் விளம்பரங்கள் இல்லை', mAdStats: 'விளம்பர புள்ளிவிவரம்', mClickToUploadAd: 'விளம்பர படத்தை பதிவேற்ற கிளிக் செய்யவும்',
    mTabOverview: 'மேலோட்டம்', mTabOrders: 'ஆர்டர்கள்', mTabMenu: 'மெனு',
    mTabMembers: 'உறுப்பினர்கள்', mTabNewItems: 'புதிய பொருட்கள்', mTabStamp: 'ஸ்டாம்ப் கார்டு',
    mTabTopup: 'டாப் அப்', mTabComplaints: 'புகார்கள்', mTabCommissions: 'கமிஷன்', mTabQR: 'QR குறியீடு',
    mAddNewItem: 'புதிய உணவு சேர்', mItemName: 'உணவு பெயர்', mItemPrice: 'விலை (RM)',
    mItemCat: 'வகை', mItemEmoji: 'Emoji ஐகான்', mItemDesc: 'விளக்கம்',
    mItemPhoto: 'உணவு புகைப்படம்', mItemPhotoOpt: '(விரும்பினால்)', mClickToUpload: 'படம் பதிவேற்ற கிளிக்',
    mRemovePhoto: 'படம் நீக்கு', mAddToMenu: 'மெனுவில் சேர்', mMenuItems: 'மெனு பட்டியல்',
    mAllMembers: 'அனைத்து உறுப்பினர்கள்', mRecentTxns: 'சமீபத்திய பரிவர்த்தனைகள்',
    mDeactivateMember: 'உறுப்பினர் நீக்கு', mConfirmDeactivate: 'நீக்கை உறுதிப்படுத்து',
    mActivateMember: 'உறுப்பினர் மீட்டமை', mConfirmActivate: 'மீட்டமைப்பை உறுதி',
    mMemberActive: 'செயலில்', mMemberInactive: 'செயலற்ற',
    mDeactivateBtn: 'நீக்கு', mActivateBtn: 'மீட்டமை',
    // Overview
    mStatMembers: 'உறுப்பினர்கள்', mStatPoints: 'வழங்கிய புள்ளிகள்', mStatOrders: 'இன்றைய ஆர்டர்கள்', mStatRevenue: 'இன்றைய வருவாய்',
    mAddPointsManually: 'கைமுறையாக புள்ளிகள் சேர்', mPhoneNumber: 'தொலைபேசி எண்',
    mBillAmount: 'பில் தொகை (RM)', mWillEarn: 'பெறுவீர்கள்', mPoints: 'புள்ளிகள்', mAddPoints: 'புள்ளிகள் சேர்', mPurchase: 'வாங்குதல்', mFreeCoffee: 'இலவச காபி',
    // Orders
    mAllOrders: 'அனைத்து ஆர்டர்கள்', mFilterAll: 'அனைத்தும்', mFilterPending: 'நிலுவையில்', mFilterPreparing: 'தயாரிக்கிறோம்', mFilterDone: 'முடிந்தது',
    // New Items
    mLaunchNewItem: 'புதிய உணவு வெளியிடு', mSelectMenuItem: 'மெனு உணவு தேர்ந்தெடு', mChooseAnItem: '-- உணவைத் தேர்ந்தெடு --',
    mSpecialPrice: 'சிறப்பு விலை (RM)', mOptional: 'விரும்பினால்',
    mLaunchDate: 'வெளியீட்டு தேதி', mEndDate: 'முடிவு தேதி',
    mAnnouncementText: 'அறிவிப்பு உரை',
    mActiveNewLaunches: 'செயலில் உள்ள புதிய வெளியீடுகள்', mNoActiveItems: 'செயலில் புதிய பொருட்கள் இல்லை',
    mPastLaunches: 'கடந்த வெளியீடுகள்', mNoPastLaunches: 'கடந்த வெளியீடுகள் இல்லை',
    // Stamp
    mCreateStampCard: 'ஸ்டாம்ப் கார்டு உருவாக்கு', mCardName: 'கார்டு பெயர்', mCardEmoji: 'கார்டு Emoji / ஐகான்',
    mStampsRequired: 'முடிக்க தேவையான ஸ்டாம்புகள்', mStampRule: 'ஸ்டாம்ப் விதி',
    mRulePerOrder: 'ஒவ்வொரு கொள்முதலுக்கும் = 1 ஸ்டாம்ப்', mRulePerAmount: 'RM X செலவிட = 1 ஸ்டாம்ப்', mRulePerItem: 'குறிப்பிட்ட பொருள் வாங்க = 1 ஸ்டாம்ப்',
    mRewardType: 'வெகுமான வகை', mRewardFreeItem: 'இலவச மெனு பொருள்', mRewardFlatDiscount: 'நிலையான தள்ளுபடி (RM)',
    mRewardPctDiscount: 'சதவீத தள்ளுபடி (%)', mRewardBonusPoints: 'போனஸ் புள்ளிகள்',
    mFreeItem: 'இலவச பொருள்', mCardColorTheme: 'கார்டு நிற கருப்பொருள்',
    mActiveStampCards: 'செயலில் உள்ள ஸ்டாம்ப் கார்டுகள்', mNoStampCards: 'இன்னும் ஸ்டாம்ப் கார்டுகள் இல்லை',
    mMemberStampProgress: 'உறுப்பினர் ஸ்டாம்ப் முன்னேற்றம்', mSearchForMember: 'உறுப்பினரைத் தேடுங்கள்',
    // Top Up
    mPendingTopupRequests: 'நிலுவையிலுள்ள டாப்-அப் கோரிக்கைகள்', mNoPendingRequests: 'நிலுவையிலுள்ள கோரிக்கைகள் இல்லை',
    mTopupBonusSettings: 'டாப்-அப் போனஸ் அமைப்புகள்', mAddBonusRule: 'போனஸ் விதி சேர்',
    mMinTopupAmount: 'குறைந்தபட்ச தொகை (RM)', mBonusPercent: 'போனஸ் (%)', mBonusExpiry: 'காலாவதி தேதி',
    mAddRule: 'விதி சேர்', mDeleteRule: 'நீக்கு', mExpired: 'காலாவதி', mNoExpiry: 'காலாவதி இல்லை',
    mMinAmt: 'குறை RM', mBonusPct: 'போனஸ்',
    mMemberWalletBalances: 'உறுப்பினர் வாலட் இருப்பு', mTopupHistory: 'டாப்-அப் வரலாறு', mNoTopupHistory: 'டாப்-அப் வரலாறு இல்லை',
    // Complaints
    mCustomerComplaints: 'வாடிக்கையாளர் புகார்கள்',
    mComplaintOpen: 'திறந்தது', mComplaintInProgress: 'செயல்பாட்டில்', mComplaintResolved: 'தீர்க்கப்பட்டது',
    // QR
    mGenerateQR: 'மேசை QR குறியீடுகள் உருவாக்கு', mQRHint: 'ஒவ்வொரு மேசைக்கும் தனி QR குறியீடு. வாடிக்கையாளர்கள் ஸ்கேன் செய்து ஆர்டர் செய்யலாம்.',
    mNumberOfTables: 'மேசைகளின் எண்ணிக்கை',
    // Commissions
    mCommissionSettings: 'கமிஷன் அமைப்புகள்', mReferralCommissionRate: 'பரிந்துரை கமிஷன் வீதம்',
    mCommissionDesc: 'பரிந்துரைப்பவர் முதல் ஆர்டர் மொத்தத்தில் % சம்பாதிக்கிறார்',
    mCurrentRate: 'தற்போதைய வீதம்:', mCommissionCredited: 'முதல் ஆர்டருக்குப் பிறகு பரிந்துரைப்பவரின் வாலட்டில் சேர்க்கப்படும்.',
    mPendingPaymentProofs: 'நிலுவையிலுள்ள கட்டண ஆதாரங்கள்', mNoPaymentProofs: 'நிலுவையிலுள்ள கட்டண ஆதாரங்கள் இல்லை',
    mCommissionRecords: 'கமிஷன் பதிவுகள்',
    mVerify: 'சரிபார்', mReject: 'நிராகரி', mApprove: 'அனுமதி',
    mPaymentVerified: 'கட்டணம் சரிபார்க்கப்பட்டது ✅',
    mPaymentRejected: 'கட்டண ஆதாரம் நிராகரிக்கப்பட்டது.',
    mNoCommissions: 'கமிஷன் பதிவுகள் இல்லை',
    mFirstOrderDone: '✅ முதல் ஆர்டர் முடிந்தது', mNotOrderedYet: '⏳ இன்னும் ஆர்டர் செய்யவில்லை',
    mTopupSubmitted: '✅ டாப்-அப் கோரிக்கை சமர்ப்பிக்கப்பட்டது! வணிகர் ஒப்புதலுக்காக காத்திருக்கிறது.',
    mTopupApproved: 'அனுமதிக்கப்பட்டது! கணக்கில் சேர்க்கப்பட்டது', mTopupRejected: 'கோரிக்கை நிராகரிக்கப்பட்டது.',
    mScreenshotUploaded: 'ஸ்கிரீன்ஷாட் பதிவேற்றப்பட்டது. வணிகர் சரிபார்ப்புக்காக காத்திருக்கிறது.',
    ...
    mStampPerPurchase: '1 ஸ்டாம்ப் / வாங்கல்', mStampPerRM: '1 ஸ்டாம்ப் / RM', mStampPerItem: '1 ஸ்டாம்ப் / குறிப்பிட்ட உணவு',
    mStampsLabel: 'ஸ்டாம்புகள்',
    mNoStampCardsYet: 'இன்னும் ஸ்டாம்ப் கார்டு இல்லை', mNoMembersYet: 'இன்னும் உறுப்பினர் இல்லை', mNoOrdersFound: 'ஆர்டர் கிடைக்கவில்லை',
    mNoTransactions: 'பரிவர்த்தனைகள் இல்லை', mNoMembersFound: 'உறுப்பினர் கிடைக்கவில்லை', mNoComplaintsFound: 'புகார்கள் கிடைக்கவில்லை',
    mNiSpecial: 'சிறப்பு: RM', mNiWas: 'முன்பு RM', mNiLaunch: 'வெளியீடு:', mNiEnds: 'முடிவு:', mNiNoEndDate: 'முடிவு தேதி இல்லை',
    mNiDeactivate: 'நிறுத்து', mNiDelete: 'நீக்கு',
    mBalance: 'இருப்பு',
    mOrderPrepare: 'தயார் செய்', mOrderDone: 'முடிந்தது',
    mOrderTakeaway: 'டேக்அவே', mOrderTable: 'மேசை', mOrderPickup: 'பிக்அப்',
    mOrderCompleted: 'ஆர்டர் முடிந்தது! ✅', mOrderMovedPreparing: 'தயாரிப்பு நிலைக்கு நகர்த்தப்பட்டது!',
    mComplaintNoPhoto: 'புகைப்படம் இணைக்கப்பட்டது', mDetailCustomer: 'வாடிக்கையாளர்', mDetailCategory: 'வகை',
    mDetailStatus: 'நிலை', mDetailOrder: 'ஆர்டர்', mDetailDate: 'தேதி', mDetailPrevResponse: 'முந்தைய பதில்',
    mComplaintResolved: 'புகார் தீர்க்கப்பட்டதாக குறிக்கப்பட்டது ✅',
...
function openDeactivateMemberModal(memberId) {
  ...
  if (isActive) {
    msg.innerHTML = `${mt('mDeactivateMember')}: <strong>${escHtml(m.name)}</strong> (${escHtml(m.phone)})?<br><small style="color:#c62828">${_merchantLang==='zh'?'解除后该会员将无法登录和使用积分。':_merchantLang==='ms'?'Ahli tidak boleh log masuk selepas dinyahaktifkan.':_merchantLang==='ta'?'நீக்கப்பட்டால் உறுப்பினர் உள்நுழைய முடியாது.':'Member will be blocked from login after deactivation.'}</small>`;
...
function confirmDeactivateMember() {
  ...
  if (idx !== -1) {
    ...
    DB.saveMembers(members);
    showToast(_merchantLang==='zh'?'会员已解除':_merchantLang==='ms'?'Ahli telah dinyahaktifkan':_merchantLang==='ta'?'உறுப்பினர் நீக்கப்பட்டார்':'Member deactivated', 'error');
    renderMemberTable(DB.getMembers());
...
function confirmActivateMember() {
  ...
  if (idx !== -1) {
    ...
    DB.saveMembers(members);
    showToast(_merchantLang==='zh'?'会员已恢复':_merchantLang==='ms'?'Ahli telah diaktifkan':_merchantLang==='ta'?'உறுப்பினர் மீட்டமைக்கப்பட்டார்':'Member activated');
    renderMemberTable(DB.getMembers());
    closeDeactivateMemberModal();
  }
}
...
async function searchMember() {
  ...
  const fb = window.__lbFirebase;
  if (!fb?.db) { showToast('Firestore 未就绪，请稍后再试', 'error'); box.classList.add('hidden'); return; }
  ...
  try {
    ...
    const snap = await fb.getDoc(ref);
    if (!snap.exists()) {
      foundMember = { id: phone, phone, name: '新会员', points: 0, exists: false };
      showToast('新会员：可创建档案（ID=手机号）', 'success');
    } else {
      const data = snap.data() || {};
      foundMember = {
        id: phone,
        phone,
        name: String(data.name || '新会员'),
...
function addPoints() {
  if (!merchantLoggedIn) { showToast(mt('mInvalidCredentials') || '请先登录商家后台', 'error'); return; }
  ...
  spendCreditAndAddMemberPointsOrThrow(foundMember.phone || foundMember.id, pts)
    ...
    .catch(err => {
      if (String(err?.message || err) === 'MERCHANT_NOT_LOGGED_IN') {
        showToast('请先登录商家后台', 'error');
        return;
      }
      if (String(err?.message || err) === 'INSUFFICIENT_CREDITS') {
        showToast('余额不足（credits = 0）', 'error');
        return;
      }
      showToast('加分失败（credits 或 member points 未更新），请稍后再试', 'error');
...
async function createMemberFromSearch() {
  ...
  if (foundMember.exists) { showToast('会员已存在', 'success'); return; }
  const fb = window.__lbFirebase;
  if (!fb?.db) { showToast('Firestore 未就绪，请稍后再试', 'error'); return; }

  const name = (prompt('新会员姓名（name）', '') || '').trim();
  if (!name) { showToast('已取消创建（name 不能为空）', 'error'); return; }
  ...
  try {
    ...
    document.getElementById('found-points').textContent = foundMember.points + ' pts — ' + getTier(foundMember.points);
    document.getElementById('found-tier').textContent = getTier(foundMember.points);
    showToast('新会员已创建', 'success');
  } catch (e) {

    showToast('创建会员失败，请稍后再试', 'error');
  }
}
    ...
    if (fb && fb.db && fb.doc && fb.getDoc) {
      fb.getDoc(fb.doc(fb.db, 'merchants', _preMerchantId)).then(function(snap) {
        if (snap.exists()) {
          ...
          if (d.name || d.announce || d.banner) {
            try { safeLS.setJSON(_getMerchantStorageKey(SHOP_SETTINGS_KEY), { name: d.name || _preMerchantId, announce: d.announce || '', banner: d.banner || '', updatedAt: new Date().toISOString() }); } catch(e) {}
          }
          if (d.pointsRate) {
...
function renderCustomerPromosPreview() {
  ...
  if (ads.length === 0) {
    el.innerHTML = '<p style="color:#aaa;text-align:center;padding:12px;font-size:0.82rem">' + (t('noPromos') || '暂无优惠') + '</p>';
    return;
  }
  ...
  m.innerHTML = '<div style="background:#0f172a;padding:32px;border-radius:20px;width:420px;max-width:95vw;color:#f1f5f9;font-family:sans-serif;border:1px solid #334155;box-shadow:0 25px 80px rgba(0,0,0,0.5)">' +
    '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px">' +
      '<div style="display:flex;align-items:center;gap:10px">' +
        ...
        '<div><div style="font-weight:700;font-size:1.1rem">新增商家</div><div style="color:#64748b;font-size:0.72rem;margin-top:2px">Register New Merchant</div></div>' +
      '</div>' +
    ...
    '<div style="display:flex;flex-direction:column;gap:14px">' +
      '<div><label style="display:block;color:#94a3b8;font-size:0.78rem;font-weight:600;margin-bottom:6px">商家名称 * <span style="color:#475569">(Merchant Name)</span></label>' +
        '<input id="mreg-name" type="text" placeholder="如：大学档口 A" style="width:100%;padding:11px 14px;background:#1e293b;border:1px solid #334155;color:#f1f5f9;border-radius:10px;font-size:0.95rem;box-sizing:border-box;outline:none" onfocus="this.style.borderColor=\'#3b82f6\'" onblur="this.style.borderColor=\'#334155\'"></div>' +
      '<div><label style="display:block;color:#94a3b8;font-size:0.78rem;font-weight:600;margin-bottom:6px">商家 ID (建议用电话号码) * <span style="color:#475569">(Merchant ID)</span></label>' +
        '<div style="display:flex;gap:8px"><input id="mreg-id" type="text" placeholder="如：0123456789" style="flex:1;padding:11px 14px;background:#1e293b;border:1px solid #334155;color:#f1f5f9;border-radius:10px;font-size:0.95rem;box-sizing:border-box;outline:none" onfocus="this.style.borderColor=\'#3b82f6\'" onblur="this.style.borderColor=\'#334155\'"><button onclick="_saGenId2()" title="随机生成" style="padding:0 16px;background:#1e3a5f;color:#60a5fa;border:1px solid #1e3a5f;border-radius:10px;cursor:pointer;font-size:1.2rem;white-space:nowrap">🎲</button></div>' +
        '<div style="color:#475569;font-size:0.72rem;margin-top:4px">💡 用电话号码当 ID 最方便，客户扫码直接认</div></div>' +
      '<div><label style="display:block;color:#94a3b8;font-size:0.78rem;font-weight:600;margin-bottom:6px">登录密码 * <span style="color:#475569">(Password)</span></label>' +
      ...
      '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">' +
        '<div><label style="display:block;color:#94a3b8;font-size:0.78rem;font-weight:600;margin-bottom:6px">初始点数 * <span style="color:#475569">(Credits)</span></label>' +
        ...
        '<div><label style="display:block;color:#94a3b8;font-size:0.78rem;font-weight:600;margin-bottom:6px">联系电话 <span style="color:#f87171">(必填)</span></label>' +
      ...
      '<div style="display:flex;gap:10px;margin-top:4px">' +
        '<button id="mreg-submit" onclick="_saSubmitReg()" style="flex:1;padding:13px;background:linear-gradient(135deg,#15803d,#16a34a);color:#fff;border:none;border-radius:12px;font-size:1rem;font-weight:700;cursor:pointer;box-shadow:0 4px 14px rgba(21,128,61,0.4)">💾 保存注册</button>' +
        '<button onclick="_saCloseRegModal()" style="padding:13px 18px;background:#1e293b;color:#94a3b8;border:1px solid #334155;border-radius:12px;font-size:0.9rem;cursor:pointer">取消</button>' +
      '</div>' +
    '</div>' +
  '</div>';
...
window._saSubmitReg = async function() {
  ...
  if(!name || !merchantId || !password) {
    if(err) { err.textContent = "请填写商家名称、商家ID、密码和联系电话"; err.style.display = "block"; }
    return;
  }
  ...
  var origText = btn ? btn.textContent : "保存注册";
  if(btn) { btn.disabled = true; btn.textContent = "提交中..."; btn.style.opacity = "0.6"; }
  try {
    var ref = fb.doc(fb.db, "merchants", merchantId);
    var existing = await fb.getDoc(ref);
    if(existing.exists()) {
      if(err) { err.textContent = "商家ID [" + merchantId + "] 已存在，请更换"; err.style.display = "block"; }
    ...
    await fb.runTransaction(fb.db, function(tx) {
      return tx.get(ref).then(function(snap) {
        if(snap.exists()) throw new Error("ID冲突");
        tx.set(ref, {
          merchant_name: name,
          credits: credits,
          phone: phone || null,
    ...
    showToast("商家 [" + name + "] 注册成功！Credits: " + credits, "success");
    _saCloseRegModal();
    if(typeof renderSuperAdminMerchantsList === "function") renderSuperAdminMerchantsList();
  } catch(e) {

    if(err) { err.textContent = "注册失败: " + (e.message || "未知错误"); err.style.display = "block"; }
    if(btn) { btn.disabled = false; btn.textContent = origText; btn.style.opacity = "1"; }
  }
};

// ══════════════════════════════════════════════════════
// 解除商家户口 — 确认弹窗 + Firestore 删除
// ══════════════════════════════════════════════════════
window._saDeactivateMerchant = function(merchantId, merchantName) {
  var fb = window.__lbFirebase;
  if(!fb || !fb.db) { showToast("Firebase未就绪", "error"); return; }
  // 确认弹窗
  ...
  overlay.innerHTML = '<div style="background:#0f172a;padding:28px;border-radius:20px;width:380px;max-width:95vw;color:#f1f5f9;font-family:sans-serif;border:1px solid #334155">' +
    '<div style="text-align:center;margin-bottom:20px">' +
      ...
      '<div style="font-weight:700;font-size:1.1rem">确认解除商家户口？</div>' +
    '</div>' +
    '<div style="background:#1e293b;border-radius:10px;padding:14px;margin-bottom:20px">' +
      '<div style="color:#94a3b8;font-size:0.78rem;margin-bottom:4px">商家名称</div>' +
      '<div style="font-weight:600">' + merchantName + '</div>' +
      '<div style="color:#94a3b8;font-size:0.78rem;margin-top:8px;margin-bottom:4px">商家 ID</div>' +
      '<div style="font-family:monospace;color:#60a5fa">' + merchantId + '</div>' +
    '</div>' +
    '<div style="background:#7f1d1d33;border:1px solid #7f1d1d55;border-radius:8px;padding:10px 12px;margin-bottom:16px;color:#f87171;font-size:0.82rem">商家将进入 14 天待删除状态，14 天后可永久解除。在此期间可在「已解除」列表恢复。</div>' +
    '<div style="display:flex;gap:10px">' +
      '<button id="sa-deactivate-confirm" style="flex:1;padding:12px;background:linear-gradient(135deg,#b91c1c,#dc2626);color:#fff;border:none;border-radius:10px;cursor:pointer;font-size:0.95rem;font-weight:600">🗑 确认解除（14天）</button>' +
      '<button onclick="document.getElementById(\'sa-deactivate-modal\').remove()" style="padding:12px 18px;background:#1e293b;color:#94a3b8;border:1px solid #334155;border-radius:10px;cursor:pointer">取消</button>' +
    '</div>' +
  '</div>';
  ...
  document.getElementById("sa-deactivate-confirm").addEventListener("click", async function() {
    ...
    if(confirmBtn) { confirmBtn.disabled = true; confirmBtn.textContent = "解除中..."; confirmBtn.style.opacity = "0.6"; }
    try {
      var ref = fb.doc(fb.db, "merchants", merchantId);
      ...
      showToast("解除失败: " + (e2.message || "未知错误"), "error");
      if(confirmBtn) { confirmBtn.disabled = false; confirmBtn.textContent = "确认解除"; confirmBtn.style.opacity = "1"; }
    }
  });
};
...
window._saRestoreMerchant = function(merchantId, merchantName) {
  var fb = window.__lbFirebase;
  if(!fb || !fb.db) { showToast("Firebase未就绪", "error"); return; }
  if(!confirm("确认恢复商家 [" + merchantName + "] 的户口？\n恢复后商家将重新出现在活跃商家列表。")) return;
  ...
  fb.updateDoc(fb.doc(fb.db, "merchants", merchantId), {
    ...
    showToast("商家 [" + merchantName + "] 已恢复", "success");
    if(typeof renderSuperAdminMerchantsList === "function") renderSuperAdminMerchantsList();
    if(typeof _loadSuperAdminMerchants === "function") _loadSuperAdminMerchants();
  }).catch(function(e2) {

    showToast("恢复失败: " + (e2.message || "未知错误"), "error");
    if(btn) { btn.disabled = false; btn.textContent = "↩ 恢复"; }
  });
};

// ══════════════════════════════════════════════════════
// 确保 showPage 全局可用 + 处理队列
// ══════════════════════════════════════════════════════
window.showPage = showPage;
console.log("[app.js] ✅ showPage 已挂载到 window");

// 处理等待中的 showPage 调用
if (window._showPageQueue && window._showPageQueue.length > 0) {
  console.log("[app.js] 处理等待中的 showPage 调用:", window._showPageQueue);
