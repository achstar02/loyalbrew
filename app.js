...
const LANGS = {
  en: {
    ...
    // Customer Auth
    login: '登录', register: 'Register', fullName: 'Full Name',
  ...
  ta: {
    mCatHotDrinks: '????? ????????', mCatColdDrinks: '?????? ????????', mCatFood: '食物', mCatDesserts: '甜点', mCatSnacks: '小吃', mCatPromotions: '促销',
...
loyalbrew_brand: 'LoyalBrew',
    ...
    // Menu
    menu: '菜单', dineIn: '????? ???????', takeaway: '?????? ??????',
    table: '桌号', change: '更换',
    selectTable: '?????? ?????? ?????????????????', enterTable: '?????? ????? ???? ??? ??????????',
    confirmTable: '?????? ??????????????', invalidTable: '?????? ???? ????? ??????????',
    // Menu categories
    catAll: '全部', catNewItems: '? ????? ?????????',
    catHotDrinks: '????? ????????', catColdDrinks: '?????? ????????',
    catFood: '食物', catDesserts: '甜点', catSnacks: '小吃',
    // Float cart
    floatViewCart: '?????? ??????? ?',
    floatItem: '商品', floatItems: '商品',
    // Takeaway info bar
    takeawayOrder: '??????? ??????', noPickupTime: '????? ????????????????', pickup: '取餐',
    // Cart
    yourOrder: '??? ??????', orderType: '?????? ???',
    ...
    eachUnit: '每单位', removeItem: '移除商品',
    orderSummary: '?????? ?????????', subtotal: '???? ???????', sst: 'SST (6%)',
    walletDeduction: '????? ?????', totalLabel: '合计',
    pointsEarnLabel: '??????? ?????? ?????????',
    specialRequest: '??????? ????????', specialRequestPlaceholder: '?.??: ??????? ????????, ??? ????????...',
    placeOrder: '?????? ????',
    // Order type display in cart
    cartDineIn: '????? ???????', cartTakeaway: '?????? ??????', cartChange: '更换商品',
    // Confirm details
    confirmType: '类型', confirmTable2: '????', confirmPhone: '手机号',
    confirmPickup: '????????? ?????', confirmItems: '商品',
    confirmWalletPaid: '????? ????', confirmTotalPaid: '????? ????',
    confirmPayment: '???? ?????????', confirmPointsEarned: '????????? ???????????',
    confirmNote: '备注', pendingVerification: '??????????? ??????????',
    ...
    tngAmountLabel: 'TnG金额', tngUploadHint: '???? ????????? ?????, ???? ???????????? ????????????.',
    ...
    selectTopUpAmount: '??????? ?????? ?????????????????', topUpGet: '充值获取', noBonus: '????? ?????',
    bestDeal: '?????? ????', free: '免费',
    orCustomAmount: '?????? ????????? ???? ?????????? (RM)',
    topUpCustomHint: '????????????? RM10. RM100 ??????? ?????? ???? ????? ???????.',
    youPay: '??????? ???????????', youGet: '??????? ???????', bonusLabel: '奖励',
    ...
    highestTier: '?? ??????? ??????? ?????? ????????????!',
    tierNameSilver: '白银会员', tierNameGold: '黄金会员', tierNamePlatinum: '铂金会员',
    // Upload
    screenshotUploaded: '???????????? ????????????????. ?????? ???????????????? ???????????????.',
    ...
    orderDetailType: '订单类型',
    orderDetailDate: '订单日期',
    orderDetailItems: '?????? ?????????',
    orderDetailSubtotal: '???? ???????',
    orderDetailTax: 'SST',
    walletTopupLabel: '????-???',
    ...
    newItemsUntil: '??????:',
    newItemsNoEnd: '?????? ???? ?????',
    complaintPhotoAlt: '投诉照片',
    awaitingMerchantApproval: '?????? ????????????? ???????????????',
    newItemsNewTag: '新品标签',
    stampComplete: '?????????!',
    complaintTab: '投诉',
    referralTab: '推荐',
    orderDetailTotal: '订单总额',
    orderDetailPointsEarned: '????????? ??????????',
    orderDetailWalletPaid: '钱包已支付',
...
const DEFAULT_MENU = [
  // ??? Pan Cake
  { id: 'as_pan_cake_pandan',   name: '??? (??) Pan Cake Pandan',     emoji: 'Emoji', price: 1.60, category: 'Traditional Cakes', desc: '????????,??', image: 'menu_photos/pancake.jpg' },
  { id: 'as_pan_cake_brownsugar',name: '??? (??) Pan Cake Brown Sugar',emoji: 'Emoji', price: 1.60, category: 'Traditional Cakes', desc: '??????,??', image: 'menu_photos/pancake.jpg' },
  { id: 'as_pan_cake_box',      name: '??? ?? (11?) Big Plate',       emoji: 'Emoji', price: 16.00,category: 'Traditional Cakes', desc: '?????,11??', image: 'menu_photos/pancake.jpg' },
  // ???? Peanut Mochi
  { id: 'as_peanut_mochi',      name: '???? Peanut Mochi (??)',       emoji: 'Emoji', price: 5.50, category: 'Mochi', desc: '??????,????', image: 'menu_photos/peanut-mochi.jpg' },
  // ??? Snow Mochi - RM4.50
  { id: 'as_snow_mochi_mango',      name: '??? (??) Snow Mochi',          emoji: 'Emoji', price: 4.50, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_oreo',       name: '??? (???) Snow Mochi',       emoji: 'Emoji', price: 4.50, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_banana_choco',name:'??? (?????) Snow Mochi',  emoji: 'Emoji', price: 4.50, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_brown_sugar', name:'??? (????) Snow Mochi',     emoji: 'Emoji', price: 4.50, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  // ??? Snow Mochi - RM5.00
  { id: 'as_snow_mochi_icecream',   name: '??? (???) Snow Mochi',       emoji: 'Emoji', price: 5.00, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_longan',     name: '??? (??) Snow Mochi',         emoji: 'Emoji', price: 5.00, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_strawberry',  name: '??? (??) Snow Mochi',         emoji: 'Emoji', price: 5.00, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  { id: 'as_snow_mochi_chocolate',   name: '??? (???) Snow Mochi',       emoji: 'Emoji', price: 5.00, category: 'Mochi', desc: '描述', image: 'menu_photos/snow-mochi.jpg' },
  // ???? Portuguese Egg Tarts
  { id: 'as_egg_tart',           name: '???? Portuguese Egg Tart',      emoji: 'Emoji', price: 3.50, category: 'Pastries', desc: '??????,??', image: 'menu_photos/egg-tart.jpg' },
];

// ===== REWARDS =====
const REWARDS = [
  { id: 'r1', name: 'Free Coffee',    icon: '图标', points: 100, color: '#8B4513' },
  { id: 'r2', name: 'Free Muffin',    icon: '图标', points: 80,  color: '#e91e63' },
  { id: 'r3', name: 'Free Tea',       icon: '图标', points: 60,  color: '#4caf50' },
  { id: 'r4', name: '10% Discount',   icon: '图标', points: 150, color: '#ff9800' },
  { id: 'r5', name: 'Free Sandwich',  icon: '图标', points: 200, color: '#9c27b0' },
  { id: 'r6', name: 'Birthday Cake',  icon: '图标', points: 300, color: '#f44336' },
];
  ...
  try {
    ...
    listEl.innerHTML = `
      <div style="display:grid;grid-template-columns:1.5fr 1fr 0.5fr 0.6fr 2fr;background:#f7f7f7;padding:12px 16px;font-weight:700;font-size:0.82rem;border-bottom:2px solid #ddd">
        <div>????</div><div>ID</div><div style="text-align:center">??</div><div style="text-align:right">Credits</div><div style="text-align:center">??</div>
      </div>
      ${merchants.map((m, i) => {
...
const MERCHANT_LANGS = {
  ...
  zh: {
    ...
    mTabOverview: '?????????', mTabOrders: '?????????', mTabMenu: '菜单',
    ...
    // Overview
    mStatMembers: '会员数', mStatPoints: '??????? ?????????', mStatOrders: '?????? ?????????', mStatRevenue: '?????? ???????',
    mAddPointsManually: '????????? ????????? ????', mPhoneNumber: '???????? ???',
    mBillAmount: '???? ???? (RM)', mWillEarn: '将获得', mPoints: '积分', mAddPoints: '????????? ????', mPurchase: '消费', mFreeCoffee: '???? ????',
    // Orders
    mAllOrders: '??????? ?????????', mFilterAll: '全部', mFilterPending: '待处理', mFilterPreparing: '准备中', mFilterDone: '已完成',
    // New Items
    mLaunchNewItem: '????? ???? ????????', mSelectMenuItem: '???? ???? ??????????', mChooseAnItem: '-- ?????? ?????????? --',
    mSpecialPrice: '??????? ???? (RM)', mOptional: '可选',
    ...
    mMinTopupAmount: '??????????? ???? (RM)', mBonusPercent: '奖励百分比 (%)', mBonusExpiry: '??????? ????',
    mAddRule: '???? ????', mDeleteRule: '删除', mExpired: '已过期', mNoExpiry: '??????? ?????',
    mMinAmt: '???? RM', mBonusPct: '奖励',
    ...
    mCommissionRecords: '?????? ????????',
    mVerify: '验证', mReject: '拒绝', mApprove: '批准',
    mPaymentVerified: '??????? ?????????????????? ?',
    mPaymentRejected: '????? ?????? ??????????????????.',
    mNoCommissions: '?????? ???????? ?????',
    mFirstOrderDone: '? ????? ?????? ?????????', mNotOrderedYet: '✓ 尚未下单'??? ?????? ???????????',
    mTopupSubmitted: '? ????-??? ???????? ???????????????????! ?????? ????????????? ???????????????.',
    ...
    // Dynamic render keys
    mStampActive: '已激活', mStampPaused: '已暂停', mStampPause: '暂停', mStampActivate: '激活', mStampDelete: '删除',
    mStampMembers: '会员数', mFreePrefix: '免费', mRmOff: '减RM', mPctOff: '折扣', mBonusPtsLabel: '积分',
    ...
    mNiDeactivate: '停用', mNiDelete: '删除',
    mBalance: '余额',
    mOrderPrepare: '????? ????', mOrderDone: '已完成',
    mOrderTakeaway: '外带', mOrderTable: '桌号', mOrderPickup: '取餐',
    mOrderCompleted: '?????? ?????????! ?', mOrderMovedPreparing: '????????? ???????? ???????????????!',
    mComplaintNoPhoto: '?????????? ??????????????', mDetailCustomer: '客户', mDetailCategory: '类别',
    mDetailStatus: '状态', mDetailOrder: '订单', mDetailDate: '日期', mDetailPrevResponse: '??????? ?????',
    mComplaintResolved: '?????? ???????????????? ??????????????? ?',
    mQRTable: '桌号二维码', mQRPrint: '打印',
...
function mt(key) {
  if (typeof MERCHANT_LANGS === 'undefined' || !MERCHANT_LANGS) return key;
...
async function searchMember() {
  ...
  try {
    ...
    const snap = await fb.getDoc(ref);
    if (!snap.exists()) {
      foundMember = { id: phone, phone, name: '名称', points: 0, exists: false };
