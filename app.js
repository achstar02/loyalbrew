...
const LANGS = {
  ...
  zh: {
    mCatHotDrinks: '热饮', mCatColdDrinks: '冷饮', mCatFood: '食物', mCatDesserts: '甜点', mCatSnacks: '小吃', mCatPromotions: '促销',
    mPromoPrice: '促销价 (RM)', mPromoPriceDesc: '可选 — 非高峰期特惠',
    // Landing
    tagline: '下单 • 赚积分 • 换奖励',
    loginLabel: '会员登录', myAccount: '我的账户', orderNow: '立即下单', myStampCard: '我的集章卡',
    topUp: '充值', merchant: '商家',
    feat1Title: '扫码下单', feat1Desc: '扫码二维码，快速下单',
    feat2Title: '赚取积分', feat2Desc: '消费RM1 = 1积分',
    feat3Title: '免费饮品', feat3Desc: '积分兑换免费饮品',
    // Menu
    menu: '菜单', dineIn: '堂食', takeaway: '外带',
    table: '桌号', change: '更改',
    selectTable: '选择您的桌号', enterTable: '输入桌号开始点餐',
    confirmTable: '确认桌号', invalidTable: '请输入有效桌号',
    // Menu categories
  create_stamp_card: '创建印章卡',
  card_name: '卡名',
  card_emoji_icon: '表情图标/图标',
  ...
  snacks: '小吃',
    ...
    // Takeaway info bar
    takeawayOrder: '外带订单', noPickupTime: '请选择取餐时间', pickup: '取餐',
    // Cart
    yourOrder: '您的订单', orderType: '订单类型',
    phoneNumber: '电话号码', pickupTime: '取餐时间',
    pickupHint: '请选择取餐时间和日期',
    loyaltyPoints: '积分 & 印章',
    earnHint: '消费积分获取规则',
    phoneLoyalty: '手机积分(积分 & 印章)',
    payWallet: '支付', useWallet: '使用钱包支付', walletBalance: '余额',
    paymentMethod: '支付方式',
    cartEmpty: '购物车为空', browseMenu: '浏览菜单',
    eachUnit: '每份', removeItem: '移除',
    orderSummary: '订单摘要', subtotal: '小计', sst: '消费税 (6%)',
    walletDeduction: '钱包扣减', totalLabel: '总计',
    pointsEarnLabel: '获得积分',
    specialRequest: '特殊要求', specialRequestPlaceholder: '如有特殊要求请注明...',
    placeOrder: '下单',
    // Order type display in cart
    cartDineIn: '堂食', cartTakeaway: '外带', cartChange: '更改',
    // Confirm details
    confirmType: '确认类型', confirmTable2: '桌号', confirmPhone: '电话',
    confirmPickup: '确认取餐', confirmItems: '确认商品',
    confirmWalletPaid: '钱包已付', confirmTotalPaid: '总额已付',
    confirmPayment: '确认支付', confirmPointsEarned: '确认获得积分',
    confirmNote: '备注', pendingVerification: '待验证',
    confirmTypeDineIn: '堂食订单', confirmTypeTakeaway: '外带订单',
    // Cash pay confirm
    cashPayCounter: '请付款,谢谢',
    cashPaidBtn: '已付款 — 确认',
    cashPaidDone: '现金已支付!正在处理...',
    confirmReceivedBtn: '确认 / 收款',
    orderCompletedMsg: '订单已完成!谢谢',
    orderCompletedTitle: '完成',
    // Toast
    toastTakeaway: '外带订单已确认!', toastDineIn: '堂食订单已确认!',
    toastNoPhone: '请输入电话号码',
    toastNoTime: '请选择取餐时间',
    toastNoProof: '请上传支付凭证',
    // Payment section
    tngScanTitle: 'Touch & Go 支付',
    tngAmountLabel: '金额', tngUploadHint: '请上传截图',
    uploadScreenshot: '上传截图', uploadReceipt: '上传收据',
    uploadSizeHint: 'JPG / PNG,最大 5MB',
    bankTitle: '银行转账',
    // Takeaway modal
    takeawayModalTitle: '外带订单', takeawayModalSubtitle: '请输入取餐信息',
    confirmTakeaway: '确认外带', cancelBtn: '取消',
    pickupReadyHint: '您的订单已准备好取餐',
    // Stamp
    enterPhone: '请输入电话号码',
    notMember: '还不是会员', registerHere: '在此注册',
    // Order Confirm
    orderPlaced: '订单已提交!', thankYou: '谢谢!',
    orderSent: '您的订单已发送给厨房',
    orderMore: '再点一单', viewStamp: '查看印章', backHome: '返回首页',
    // Stamp card
    stampReward: '奖励', stampClaimBtn: '领取奖励',
    stampPerPurchase: '每单1印章',
    stampPerAmount: '消费RM{v} = 1印章',
    stampPerItem: '每{item} = 1印章',
    stampPerItemGeneric: '每购买一个 = 1印章',
    stampFreeItem: '免费{item}', stampFreeItemGeneric: '免费商品',
    stampRmOff: '减RM{v}', stampPctOff: '{v}折', stampBonusPoints: '+{v}积分',
    stampsToUnlock'再{n}个印章解锁?', stampsToUnlockPlural'再{n}个印章解锁?',
    stampCollected: '已收集', stampEmpty: '无印章',
    stampCompleted: '已收集{n}个',
    // Customer Auth
    ...
    // My Orders page
    loginRequired: '需要登录', loginToViewOrders: '登录以查看您的订单',
    goToLogin: '去登录',
    filterAll: '全部', filterPending: '待处理', filterPreparing: '准备中', filterDone: '已完成',
    // Top Up page
    topUpWallet: '充值钱包', myWallet: '我的钱包', bonusIncluded: '包含奖励',
    topUpBonusTitle: '充值奖励!', topUpBonusDesc: '充值RM100送RM120(额外RM20!)',
    selectTopUpAmount: '选择充值金额', topUpGet: '获得', noBonus: '无奖励',
    bestDeal: '超值', free: '免费',
    orCustomAmount: '或其他金额 (RM)',
    topUpCustomHint: '最低RM10,最高RM100,请输入金额',
    youPay: '您支付', youGet: '您获得', bonusLabel: '奖励',
    confirmTopUp: '确认充值', walletHistory: '钱包历史',
    // Wallet dashboard
    availableBalance: '可用余额', totalToppedUp: '总充值', totalBonusEarned: '总获得奖励',
    // Tier hint
    sinceLabel: '自',
    pointsToReach: '再{n}积分升级{tier}!',
    highestTier: '已达最高等级!',
    tierNameSilver: '白银', tierNameGold: '黄金', tierNamePlatinum: '铂金',
    // Upload
    screenshotUploaded: '已上传,请稍等',
    screenshotUploaded2: '已上传', tapToChange: '点击更改',
    topupSubmitted: '充值已提交!请稍等...',
    selectTableFirst: '请先选择桌位!',
    photoUnder5MB: '照片小于5MB',
    noPromos: '暂无促销',
    noComplaintsYet: '暂无投诉',
    mPhComplaintDesc: '请描述您的问题...',
    mPhComplaintOrderId: '订单号:ORD123456',
    enterValidRate: '请输入有效评分(1–100)',
    T: 'T',
    div: 'div',
    input: 'input',
    m: 'm',
    ...
    mEnterValidBill: '请输入有效金额',
    mFreeCoffee: '免费咖啡',
    mMemberInactive: '会员未激活',
    mNoMembersYet: '暂无会员',
    mOrderPickup: '取餐订单',
    mOrderPrepare: '准备中',
    mOrderTakeaway: '外带订单',
    ...
    mQRTable: '桌位二维码',
    backHome: '返回首页',
    bankAccountDisplay: '显示银行账户',
    commission_rate: '佣金比率',
    credited_to_referrer_s_wallet_after_first_order: '首次订单后存入推荐人钱包',
    customer_complaints: '客户投诉',
    enter_your_referrer_s_phone_number_to_link_commissions: '请输入推荐人的电话号码以链接佣金',
    ...
    memberNotFound: '未找到会员,请重试',
    noUnclaimedRewards: '无可领取奖励',
    enterCardName: '输入卡名',
    enterRewardValue: '输入奖励值',
    minimumTopup: '最低充值RM10',
    selectTopupAmount: '选择充值金额',
    sessionExpired: '会话过期,请重新登录',
    memberNotFoundShort: '未找到会员',
    pleaseLoginFirst: '请先登录',
    pleaseDescribeIssue: '请描述问题',
    enterPhoneToLogin: '输入电话号码登录',
    memberNotFoundRegister: '未找到会员,请注册',
    fillNamePhone: '请填写姓名和电话',
    phoneRegistered: '电话号码已注册!',
    referrerNotFound: '未找到推荐人,请重试',
    notEnoughPoints: '积分不足!',
    invalidCredentials: '无效凭据!',
    enterPhoneSearch: '输入电话号码搜索',
    memberNotFoundExcl: '未找到会员!',
    ...
    stampCollectedDetail: '已收集{n}个印章',
    walletTopupPending: '钱包充值待处理',
    myOrdersEmpty: '我的订单为空',
    myOrdersNoOrdersYet: '暂无订单',
    walletTxnsEmpty: '钱包交易为空',
    txnNoTransactions: '暂无交易',
    topupHistoryEmpty: '充值历史为空',
    complaintsEmpty: '投诉为空',
    photoUploadHint: 'JPG/PNG,最大 5MB',
    orderDetailTitle: '订单详情',
    orderDetailOrderId: '订单ID',
    ...
    statusDone: '已完成',
    stampRedeemTitle: '奖励!',
    stampRedeemMsg: '您已获得奖励!',
    stampRedeemClaim: '领取奖励',
    stampRedeemLater: '稍后',
    newItemsTitle: 'LoyalBrew ????!',
    newItemsMsg: '查看最新新品 请点',
    newItemsOrderNow: '立即下单',
    newItemsClose: '关闭',
    referralReferral: '推荐',
    referralInviteFriends: '邀请好友,获得奖励!',
    referralShareCode: '分享您的推荐码,好友首次下单您可获得佣金!',
    referralCopyCode: '复制',
    referralFriendsReferred: '已推荐好友',
    referralTotalEarned: '总收益',
    referralCommissionRate: '佣金比率',
    referralCommissionHistory: '佣金历史',
    referralFriendsYouReferred: '您推荐的好友',
    referralNoCommissions: '暂无佣金,继续努力!',
    referralNoFriends: '暂无推荐好友',
    complaintSubmitComplaint: '提交投诉',
    complaintCategory: '投诉类别',
    complaintDescription: '描述',
    complaintUploadPhoto: '上传照片(可选)',
    complaintTapUpload: '点击上传',
    complaintOrderIdOpt: '订单号(可选)',
    complaintSubmit: '提交',
    complaintMyComplaints: '我的投诉',
    complaintComplaintDetail: '投诉详情',
    complaintResponse: '回复 / 商家回复',
    complaintResolve: '标记已解决',
    complaintClose: '关闭',
    complaintNoPhoto: '暂无照片',
    complaintResolveDone: '投诉已解决 请',
    complaintDetailTitle: '投诉详情',
    complaintEnterResponse: '请输入回复...',
    newItemsBanner: '新品',
    newItemsSpecial: '特价:',
    newItemsWas: '原价',
    newItemsUntil: '截止:',
    ...
    orderDetailWalletPaid: '钱包已付',
    orderDetailWalletDeductLabel: '钱包扣减',
    active_new_launches: '新品上市',
    active_stamp_cards: '印章卡活动',
    ...
    all_members: '所有会员',
    all_orders: '所有订单',
    announcement_placeholder: '请输入公告内容...',
    ...
    card_color_theme: '卡片颜色主题',
    card_name: '卡片名称',
    card_name_placeholder: '提示:最多10个字符,请输入卡片名称',
    cash: '现金',
    category: '类别',
    cleanliness: '卫生',
    ...
    referral_code_label: '推荐码(可选,请输入)',
    registeringAsMember: '正在注册为会员,请稍等',
    create_stamp_card: '创建印章卡',
    ...
    merchant_login: '商家登录',
    new_complaint: '新投诉',
    no_active_new_items: '暂无新品',
    no_past_launches: '暂无历史发布',
    no_pickup_time_set: '未设置取餐时间',
    no_stamp_cards_yet: '暂无印章卡',
    optional: '可选',
    orders: '订单',
    orders_today: '今日订单',
    other: '其他',
    ...
    referral_commission_rate: '推荐佣金比率',
    remove_photo: '移除照片',
    revenue_today: '今日收入',
    reward_type: '奖励类型',
    save_password: '保存密码',
    ...
    stamp_cards: '印章卡',
    stamp_rule: '印章规则',
    stamp_rule_placeholder: '提示:例如消费RM10得1印章',
    stamps_required_to_complete: '完成所需印章',
    submit_complaint: '提交投诉',
    top_up: '充值',
    username: '用户名',
    wrong_order: '错误订单',
    referralCommissionEarned: '推荐佣金收益',
    referralCurrentRate: '当前比率',
    referralSharePrompt: '分享您的推荐码 {phone} 给好友,他们首次消费您可获得 {rate}% 佣金!',
    // Ads
    ads: '广告',
    create_ad: '创建广告',
    ad_title: '广告标题',
    ...
    promosAndDeals: '促销和优惠',
    viewAllPromos: '查看所有促销',
    allPromos: '所有促销',
    noPromosNow: '暂无促销,敬请期待!',
 
    welcomeBack: '欢迎回来',
    drinkToday: '今天想喝什么',
    firebaseNote: '关于Firebase:关于 credits,请参考文档 1',
    enter: '输入',
    get: '获取',
    view: '查看',
    back: '返回',
    ...
    mInvalidCredentials: '无效凭据',
    mMemberActive: '会员激活', mMemberInactive: '会员未激活',
    mActivateMember: '激活会员', mDeactivateMember: '停用会员',
    mActivateBtn: '激活', mDeactivateBtn: '停用',
    mConfirmActivate: '确认激活会员?',
    mConfirmDeactivate: '确认停用',
    mOrderDone: '已完成', mOrderPrepare: '准备中',
    mOrderCompleted: '已完成', mOrderPickup: '取餐',
    mOrderTable: '桌号', mOrderTakeaway: '外带',
    mOrderMovedPreparing: '已移至准备中',
    mFirstOrderDone: '首单完成!', mNotOrderedYet: '尚未下单',
    mNoOrdersFound: '未找到订单', mNoOrdersCategory: '该类别暂无订单',
    mKitchenStartCooking: '开始烹饪', mKitchenCookingStarted: '烹饪已开始',
    mKitchenMarkDone: '标记完成', mKitchenCompleted: '已完成',
    mKitchenGuest: '客人', mKitchenTable: '桌号', mKitchenTakeaway: '外带', mKitchenPickup: '取餐',
    mEnterPhone: '输入电话', mEnterCardName: '输入卡名',
    mFillNamePrice: '请填写名称和价格',
    mNoMembersFound: '未找到会员', mNoMembersYet: '暂无会员',
    mStampActivate: '激活', mStampActive: '激活',
    mStampPause: '暂停', mStampPaused: '已暂停',
    mStampDelete: '删除', mStampMembers: '会员',
    mStampPerItem: '每项', mStampPerPurchase: '每单', mStampPerRM: '每RM',
    ...
    mNoActiveItems: '暂无活跃项', mNoPastLaunches: '暂无历史发布',
    mTopupSubmitted: '???????!', mTopupApproved: '已批准', mTopupRejected: '已拒绝',
    mNoPendingRequests: '暂无待处理请求', mNoTopupHistory: '暂无充值历史',
    mMinTopupAmount: '????RM10',
    mBalance: '余额', mPoints: '积分',
    mNoTransactions: '暂无交易',
    mAddRule: '添加规则', mDeleteRule: '删除规则',
    mBonusPercent: '奖励 (%)', mBonusPct: '%', mBonusPtsLabel: '积分',
    mBonusExpiry: '到期日期', mNoExpiry: '无过期日期',
    mMinAmt: '最低金额(RM)', mEnterValidBill: '请输入有效账单',
    mEnterValidRate: '请输入有效比率(1-100)',
    mRewardFreeItem: '免费商品', mRewardFlatDiscount: '固定折扣(RM)',
    mRewardPctDiscount: '百分比折扣(%)', mRewardBonusPoints: '奖励积分',
    mPurchase: '消费', mRmOff: '减RM', mPctOff: '%',
    mFreePrefix: '免费', mFreeItem: '免费商品', mFreeCoffee: '免费咖啡',
    mComplaintOpen: '待处理', mComplaintInProgress: '处理中',
    mComplaintResolved: '已解决', mComplaintNoPhoto: '无照片',
    mApprove: '批准', mReject: '拒绝',
    mNoComplaintsFound: '未找到投诉',
    mNoCommissions: '暂无佣金',
    mPaymentVerified: '付款已验证 ✓', mPaymentRejected: '付款已拒绝',
    mNoPaymentProofs: '暂无付款凭证',
    mPhotoUnder5MB: '??????5MB',
    mQRNotReady: '二维码未就绪', mQRPrint: '打印二维码', mQRTable: '桌位二维码',
    mSelectMenuItem: '选择菜单项', mChooseAnItem: '-- 选择商品 --',
    mExpired: '已过期',
    mDetailStatus: '状态', mDetailDate: '日期', mDetailCustomer: '客户',
    mDetailOrder: '订单', mDetailCategory: '类别',
    mDetailPrevResponse: '之前回复',
...
const MERCHANT_LANGS = {
  ...
  zh: {
    ...
    mTabAds: '广告',
    mCreateAd: '创建广告', mAdTitle: '广告标题', mAdLink: '链接 URL(可选)', mAdStart: '开始日期', mAdEnd: '结束日期', mAdImage: '广告图片', mAdPosition: '显示位置', mAdPriority: '优先级', mAdPriorityHint: '数字越大=优先显示', mActiveAds: '活跃广告', mNoActiveAds: '暂无活跃广告', mAllAds: '所有广告', mNoAds: '暂无广告', mAdStats: '广告统计', mClickToUploadAd: '点击上传广告图片',
    mTabOverview: '查看', mTabOrders: '订单', mTabMenu: '菜单',
    mTabMembers: '会员', mTabNewItems: '新品', mTabStamp: '印章',
    mTabTopup: '充值', mTabComplaints: '投诉', mTabCommissions: '佣金', mTabQR: '二维码',
    mAddNewItem: '添加商品', mItemName: '商品名称', mItemPrice: '价格 (RM)',
    mItemCat: '类别', mItemEmoji: 'Emoji 图标', mItemDesc: '描述',
    mItemPhoto: '商品照片', mItemPhotoOpt: '(可选)', mClickToUpload: '点击上传照片',
    mRemovePhoto: '移除照片', mAddToMenu: '添加到菜单', mMenuItems: '菜单列表',
    mAllMembers: '所有会员', mRecentTxns: '最近交易',
    mDeactivateMember: '停用会员', mConfirmDeactivate: '确认停用',
    mActivateMember: '激活会员', mConfirmActivate: '确认激活',
    mMemberActive: '已激活', mMemberInactive: '会员未激活',
    mDeactivateBtn: '停用', mActivateBtn: '激活',
    // Overview
    mStatMembers: '会员数', mStatPoints: '已发放积分', mStatOrders: '今日订单', mStatRevenue: '今日营收',
    ...
    // Orders
    mAllOrders: '所有订单', mFilterAll: '全部', mFilterPending: '待处理', mFilterPreparing: '准备中', mFilterDone: '已完成',
    // New Items
    mLaunchNewItem: '发布新品', mSelectMenuItem: '选择菜单项', mChooseAnItem: '-- 选择商品 --',
    mSpecialPrice: '特价 (RM)', mOptional: '可选',
    mLaunchDate: '发布日期', mEndDate: '结束日期',
    mAnnouncementText: '公告文本',
    mActiveNewLaunches: '活跃新品', mNoActiveItems: '暂无活跃项',
    mPastLaunches: '历史发布', mNoPastLaunches: '暂无历史发布',
    // Stamp
    mCreateStampCard: '创建印章卡', mCardName: '卡片名称', mCardEmoji: '卡片 Emoji / 图标',
    mStampsRequired: '所需印章数', mStampRule: '印章规则',
    mRulePerOrder: '每订单 = 1 印章', mRulePerAmount: '每 RM X = 1 印章', mRulePerItem: '购买指定商品 = 1 印章',
    mRewardType: '奖励类型', mRewardFreeItem: '免费菜单商品', mRewardFlatDiscount: '固定折扣 (RM)',
    mRewardPctDiscount: '百分比折扣 (%)', mRewardBonusPoints: '奖励积分',
    mFreeItem: '免费商品', mCardColorTheme: '卡片颜色主题',
    mActiveStampCards: '活跃印章卡', mNoStampCards: '暂无印章卡',
    mMemberStampProgress: '会员印章进度', mSearchForMember: '搜索会员',
    // Top Up
    mPendingTopupRequests: '待处理充值请求', mNoPendingRequests: '暂无待处理请求',
    mTopupBonusSettings: '充值奖励设置', mAddBonusRule: '添加奖励规则',
    mMinTopupAmount: '最低充值金额 (RM)', mBonusPercent: '奖励百分比 (%)', mBonusExpiry: '奖励到期',
    mAddRule: '添加规则', mDeleteRule: '删除', mExpired: '已过期', mNoExpiry: '无过期日期',
    mMinAmt: '最低 RM', mBonusPct: '奖励',
    mMemberWalletBalances: '会员钱包余额', mTopupHistory: '充值历史', mNoTopupHistory: '暂无充值历史',
    // Complaints
    mCustomerComplaints: '客户投诉',
    mComplaintOpen: '待处理', mComplaintInProgress: '处理中', mComplaintResolved: '已解决',
    // QR
    mGenerateQR: '生成二维码', mQRHint: '扫描二维码,开始点餐',
    mNumberOfTables: '桌位数',
    // Commissions
    mCommissionSettings: '佣金设置', mReferralCommissionRate: '推荐佣金比率',
    mCommissionDesc: '首次订单后佣金存入推荐人钱包',
    mCurrentRate: '当前比率:', mCommissionCredited: '佣金已存入推荐人钱包',
    mPendingPaymentProofs: '待处理付款凭证', mNoPaymentProofs: '暂无付款凭证',
    mCommissionRecords: '佣金记录',
    mVerify: '验证', mReject: '拒绝', mApprove: '批准',
    mPaymentVerified: '付款已验证 ✓',
    mPaymentRejected: '付款已拒绝',
    mNoCommissions: '暂无佣金',
    mFirstOrderDone: '✓ 首单完成', mNotOrderedYet: '✓ 尚未下单',
    mTopupSubmitted: '✓ 充值已提交!请稍等',
    mTopupApproved: '已批准!请稍等', mTopupRejected: '充值已拒绝',
    mScreenshotUploaded: '已上传,请稍等',
    mScreenshotUploaded2: '已上传', mTapToChange: '点击更改',
    cancelBtn: '取消',
    mPhBillAmount: '例:25.50', mPhItemName: '例:商品名', mPhItemDesc: '描述...', mPhSpecialPrice: '例:9.90', mPhPromoPrice: '例:3.50',
    mPhAnnounce: '例:新品发布了!限时优惠...', mPhSearchMember: '搜索会员...', mPhCardName: '例:印章卡名',
    // Dynamic render keys
    mStampActive: '已激活', mStampPaused: '已暂停', mStampPause: '暂停', mStampActivate: '激活', mStampDelete: '删除',
    mStampMembers: '会员数', mFreePrefix: '免费', mRmOff: '减RM', mPctOff: '折扣', mBonusPtsLabel: '奖励',
    mStampPerPurchase: '每订单 = 1 印章', mStampPerRM: '每RM', mStampPerItem: '每购买项 = 1 印章',
    mStampsLabel: '印章数',
    mNoStampCardsYet: '暂无印章卡', mNoMembersYet: '暂无会员', mNoOrdersFound: '未找到订单',
    mNoTransactions: '暂无交易', mNoMembersFound: '未找到会员', mNoComplaintsFound: '未找到投诉',
    mNiSpecial: '特价:RM', mNiWas: '原价 RM', mNiLaunch: '发布:', mNiEnds: '截止:', mNiNoEndDate: '无截止日期',
    mNiDeactivate: '停用', mNiDelete: '删除',
    mBalance: '余额',
    ...
    mComplaintNoPhoto: '无照片', mDetailCustomer: '客户', mDetailCategory: '类别',
    mDetailStatus: '状态', mDetailOrder: '订单', mDetailDate: '日期', mDetailPrevResponse: '之前回复',
    mComplaintResolved: '投诉已解决 ✓',
    mQRTable: '桌号', mQRPrint: '打印',
    mNoActiveItems: '暂无活跃项', mNoPastLaunches: '暂无历史发布',
    mPhComplaintDesc: '请描述您的问题...', mPhComplaintOrderId: '订单号:ORD123456',
  },
    ms: {
    mCatHotDrinks: 'Minuman Panas', mCatColdDrinks: 'Minuman Sejuk', mCatFood: 'Makanan', mCatDesserts: 'Pencuci Mulut', mCatSnacks: 'Makanan Ringan', mCatPromotions: 'Promosi',
    mPromoPrice: 'Harga Promo (RM)', mPromoPriceDesc: 'pilihan — untuk promosi off-peak',
